function J = CRACMM3_J(Met,Jmethod)
% Calculates photolysis frequencies for the cracmm3 mechanism in the CMAQ model
...
switch Jmethod
    case {0,'MCM'}
        error(['MCM option not functional for cracmm3 mechanism.'])
...
% chlorine species photolysis - mostly follow GEOSCHEM_J
