...
%  39, <TRP55>
i=i+1;
Rnames{  39} = 'TRPN = NO2 +  0.67000*KET +  0.33000*UALD ';
k(:,i) = (JONIT_RACM2 ); 
Gstr{i,   1}='TRPN';
fTRPN(i)=fTRPN(i)-1.0;
...
% 133, <R114a>
i=i+1;
Rnames{ 133} = 'OP3 + HO = 0.01000*HO +  0.44000*HC10P +  0.07000*XO2 +  0.08000*ALD +  0.41000*KET ';
k(:,i) = (  3.4000E-12.*exp(  1.9000E+02./T) ); 
...
% 142, <TRP07>
i=i+1;
Rnames{ 142} = 'TRPN + HO = 0.33000*HONIT +  0.67000*NO2 +  0.27000*PINAL +  0.38000*KET +  0.21000*HCHO +  0.02000*ALD ';
k(:,i) = (  4.8000E-12 ); 
Gstr{i,   1}='TRPN';Gstr{i,   2}='HO';
fTRPN(i)=fTRPN(i)-1.0;fHO(i)=fHO(i)-1.0;
fHONIT(i)=fHONIT(i)+  0.3300;fNO2(i)=fNO2(i)+  0.6700;fPINAL(i)=fPINAL(i)+  0.2700;fKET(i)=fKET(i)+  0.3800;fHCHO(i)=fHCHO(i)+  0.2100;fALD(i)=fALD(i)+  0.0200;

% 143, <TRP57>
i=i+1;
Rnames{ 143} = 'HONIT + HO = HKET + NO3 ';
 xk0 =   2.4000E-14.*exp(  4.6000E+02./T);
 xk2 =   2.7000E-17.*exp(  2.1990E+03./T);
 xk3 =   6.5000E-34.*exp(  1.3350E+03./T);
k(:,i) = (xk0+xk3.*M./(1.0+xk3.*M./xk2) ); 
...
% 150, <TRP09>
i=i+1;
Rnames{ 150} = 'TRPN + O3 = 0.33000*HONIT +  0.67000*NO2 +  0.27000*PINAL +  0.38000*KET +  0.21000*HCHO +  0.02000*ALD ';
k(:,i) = (  1.6700E-16 ); 
...
% 163, <TRP10>
i=i+1;
Rnames{ 163} = 'TRPN + NO3 = 0.33000*HONIT +  0.67000*NO2 +  0.27000*PINAL +  0.38000*KET +  0.21000*HCHO +  0.02000*ALD ';
...
% 194, <R189>
i=i+1;
Rnames{ 194} = 'APIP1 + NO = 0.23700*TRPN +  0.76300*HO2 +  0.76300*NO2 +  0.19500*PINAL +  0.28400*ALD +  0.08650*ACT +  0.12850*LIMAL +  0.30800*HCHO +  0.07150*OPB +  0.08400*KET ';
k(:,i) = (  2.7000E-12.*exp(  3.6000E+02./T) ); 
Gstr{i,   1}='APIP1';Gstr{i,   2}='NO';
fAPIP1(i)=fAPIP1(i)-1.0;fNO(i)=fNO(i)-1.0;
fTRPN(i)=fTRPN(i)+  0.2370;fHO2(i)=fHO2(i)+  0.7630;fNO2(i)=fNO2(i)+  0.7630;fPINAL(i)=fPINAL(i)+  0.1950;fALD(i)=fALD(i)+  0.2840;fACT(i)=fACT(i)+  0.0865;fLIMAL(i)=fLIMAL(i)+  0.1285;fHCHO(i)=fHCHO(i)+  0.3080;fOPB(i)=fOPB(i)+  0.0715;fKET(i)=fKET(i)+  0.0840;

% 195, <TRP13>
i=i+1;
Rnames{ 195} = 'APIP2 + NO = 0.82000*HO +  0.82000*NO2 + HOM ';
k(:,i) = (  4.0000E-12 ); 
Gstr{i,   1}='APIP2';Gstr{i,   2}='NO';
fAPIP2(i)=fAPIP2(i)-1.0;fNO(i)=fNO(i)-1.0;
fHO(i)=fHO(i)+  0.8200;fNO2(i)=fNO2(i)+  0.8200;fHOM(i)=fHOM(i)+  1.0000;

% 196, <TRP14>
i=i+1;
Rnames{ 196} = 'APINP1 + NO = 1.69550*NO2 +  0.23450*TRPN +  0.07000*ONIT +  0.60450*PINAL +  0.15400*ALD +  0.00700*KET +  0.00700*HCHO +  0.16450*HO2 ';
k(:,i) = (  2.7000E-12.*exp(  3.6000E+02./T) ); 
Gstr{i,   1}='APINP1';Gstr{i,   2}='NO';
fAPINP1(i)=fAPINP1(i)-1.0;fNO(i)=fNO(i)-1.0;
fNO2(i)=fNO2(i)+  1.6955;fTRPN(i)=fTRPN(i)+  0.2345;fONIT(i)=fONIT(i)+  0.0700;fPINAL(i)=fPINAL(i)+  0.6045;fALD(i)=fALD(i)+  0.1540;fKET(i)=fKET(i)+  0.0070;fHCHO(i)=fHCHO(i)+  0.0070;fHO2(i)=fHO2(i)+  0.1645;

% 197, <TRP15>
i=i+1;
Rnames{ 197} = 'APINP2 + NO = 0.82000*NO2 +  0.82000*HO + HOM ';
k(:,i) = (  4.0000E-12 ); 
Gstr{i,   1}='APINP2';Gstr{i,   2}='NO';
fAPINP2(i)=fAPINP2(i)-1.0;fNO(i)=fNO(i)-1.0;
fNO2(i)=fNO2(i)+  0.8200;fHO(i)=fHO(i)+  0.8200;fHOM(i)=fHOM(i)+  1.0000;

% 198, <R190>
i=i+1;
Rnames{ 198} = 'LIMP1 + NO = 0.23000*TRPN +  0.77000*NO2 +  0.77000*LIMAL +  0.77000*HO2 +  0.43000*HCHO ';
k(:,i) = (  2.7000E-12.*exp(  3.6000E+02./T) ); 
Gstr{i,   1}='LIMP1';Gstr{i,   2}='NO';
fLIMP1(i)=fLIMP1(i)-1.0;fNO(i)=fNO(i)-1.0;
fTRPN(i)=fTRPN(i)+  0.2300;fNO2(i)=fNO2(i)+  0.7700;fLIMAL(i)=fLIMAL(i)+  0.7700;fHO2(i)=fHO2(i)+  0.7700;fHCHO(i)=fHCHO(i)+  0.4300;

% 199, <TRP16>
i=i+1;
Rnames{ 199} = 'LIMP2 + NO = 0.77000*HO +  0.77000*NO2 + HOM ';
k(:,i) = (  4.0000E-12 ); 
Gstr{i,   1}='LIMP2';Gstr{i,   2}='NO';
fLIMP2(i)=fLIMP2(i)-1.0;fNO(i)=fNO(i)-1.0;
fHO(i)=fHO(i)+  0.7700;fNO2(i)=fNO2(i)+  0.7700;fHOM(i)=fHOM(i)+  1.0000;

% 200, <TRP17>
i=i+1;
Rnames{ 200} = 'LIMNP1 + NO = 0.57000*TRPN +  0.07000*ONIT +  1.36000*NO2 +  0.43000*LIMAL +  0.50000*HO2 ';
k(:,i) = (  2.7000E-12.*exp(  3.6000E+02./T) ); 
Gstr{i,   1}='LIMNP1';Gstr{i,   2}='NO';
fLIMNP1(i)=fLIMNP1(i)-1.0;fNO(i)=fNO(i)-1.0;
fTRPN(i)=fTRPN(i)+  0.5700;fONIT(i)=fONIT(i)+  0.0700;fNO2(i)=fNO2(i)+  1.3600;fLIMAL(i)=fLIMAL(i)+  0.4300;fHO2(i)=fHO2(i)+  0.5000;

% 201, <TRP18>
i=i+1;
Rnames{ 201} = 'LIMNP2 + NO = 0.77000*NO2 +  0.77000*HO + HOM ';
k(:,i) = (  4.0000E-12 ); 
Gstr{i,   1}='LIMNP2';Gstr{i,   2}='NO';
fLIMNP2(i)=fLIMNP2(i)-1.0;fNO(i)=fNO(i)-1.0;
fNO2(i)=fNO2(i)+  0.7700;fHO(i)=fHO(i)+  0.7700;fHOM(i)=fHOM(i)+  1.0000;
...
% 203, <TRP20>
i=i+1;
Rnames{ 203} = 'LIMALP + NO = 0.64000*TRPN +  0.36000*NO2 +  0.36000*HO2 +  0.36000*HCHO +  0.36000*PAA ';
k(:,i) = (  2.7000E-12.*exp(  3.6000E+02./T) ); 
Gstr{i,   1}='LIMALP';Gstr{i,   2}='NO';
fLIMALP(i)=fLIMALP(i)-1.0;fNO(i)=fNO(i)-1.0;
fTRPN(i)=fTRPN(i)+  0.6400;fNO2(i)=fNO2(i)+  0.3600;fHO2(i)=fHO2(i)+  0.3600;fHCHO(i)=fHCHO(i)+  0.3600;fPAA(i)=fPAA(i)+  0.3600;
...
% 234, <ROCARO52>
i=i+1;
Rnames{ 234} = 'XYLP + HO2 = 0.04820*OP2 +  0.67470*OP3 +  0.27710*VROCP0OXY4 ';
k(:,i) = (  2.9100E-13.*exp(  1.3000E+03./T) ); 
Gstr{i,   1}='XYLP';Gstr{i,   2}='HO2';
fXYLP(i)=fXYLP(i)-1.0;fHO2(i)=fHO2(i)-1.0;
fOP2(i)=fOP2(i)+  0.0482;fOP3(i)=fOP3(i)+  0.6747;fVROCP0OXY4(i)=fVROCP0OXY4(i)+  0.2771;

% 235, <ROCARO62>
i=i+1;
Rnames{ 235} = 'EBZP + HO2 = 0.08540*OP2 +  0.63410*OP3 +  0.28050*VROCP0OXY4 ';
k(:,i) = (  2.9100E-13.*exp(  1.3000E+03./T) ); 
Gstr{i,   1}='EBZP';Gstr{i,   2}='HO2';
fEBZP(i)=fEBZP(i)-1.0;fHO2(i)=fHO2(i)-1.0;
fOP2(i)=fOP2(i)+  0.0854;fOP3(i)=fOP3(i)+  0.6341;fVROCP0OXY4(i)=fVROCP0OXY4(i)+  0.2805;
...
% 238, <TRP22>
i=i+1;
Rnames{ 238} = 'APINP1 + HO2 = 0.46100*TRPN +  0.45500*PINAL +  0.53900*NO2 +  0.61950*HO +  0.07700*ALD +  0.00700*KET +  0.00700*HCHO ';
k(:,i) = (  2.7100E-13.*exp(  1.3000E+03./T) ); 
Gstr{i,   1}='APINP1';Gstr{i,   2}='HO2';
fAPINP1(i)=fAPINP1(i)-1.0;fHO2(i)=fHO2(i)-1.0;
fTRPN(i)=fTRPN(i)+  0.4610;fPINAL(i)=fPINAL(i)+  0.4550;fNO2(i)=fNO2(i)+  0.5390;fHO(i)=fHO(i)+  0.6195;fALD(i)=fALD(i)+  0.0770;fKET(i)=fKET(i)+  0.0070;fHCHO(i)=fHCHO(i)+  0.0070;

% 239, <TRP23>
i=i+1;
Rnames{ 239} = 'APINP2 + HO2 = HOM ';
k(:,i) = (  1.5000E-11 ); 
...
% 277, <TRP30>
i=i+1;
Rnames{ 277} = 'APINP1 + MO2 = 0.34100*TRPN +  0.96400*HCHO +  0.04300*MOH +  0.91800*HO2 +  0.65900*NO2 +  0.53300*PINAL +  0.00700*KET +  0.11900*ALD ';
k(:,i) = (  2.0000E-12 ); 
Gstr{i,   1}='APINP1';Gstr{i,   2}='MO2';
fAPINP1(i)=fAPINP1(i)-1.0;fMO2(i)=fMO2(i)-1.0;
fTRPN(i)=fTRPN(i)+  0.3410;fHCHO(i)=fHCHO(i)+  0.9640;fMOH(i)=fMOH(i)+  0.0430;fHO2(i)=fHO2(i)+  0.9180;fNO2(i)=fNO2(i)+  0.6590;fPINAL(i)=fPINAL(i)+  0.5330;fKET(i)=fKET(i)+  0.0070;fALD(i)=fALD(i)+  0.1190;

% 278, <TRP31>
i=i+1;
Rnames{ 278} = 'APINP2 + MO2 = 0.75000*HO2 +  0.75000*NO2 +  0.25000*MOH +  0.75000*HCHO + HOM ';
k(:,i) = (  1.0000E-10 ); 
Gstr{i,   1}='APINP2';Gstr{i,   2}='MO2';
fAPINP2(i)=fAPINP2(i)-1.0;fMO2(i)=fMO2(i)-1.0;
fHO2(i)=fHO2(i)+  0.7500;fNO2(i)=fNO2(i)+  0.7500;fMOH(i)=fMOH(i)+  0.2500;fHCHO(i)=fHCHO(i)+  0.7500;fHOM(i)=fHOM(i)+  1.0000;
...
% 282, <TRP34>
i=i+1;
Rnames{ 282} = 'LIMNP2 + MO2 = 0.75000*HO2 +  0.75000*HCHO +  0.75000*NO2 +  0.25000*MOH + HOM ';
k(:,i) = (  1.0000E-10 ); 
Gstr{i,   1}='LIMNP2';Gstr{i,   2}='MO2';
fLIMNP2(i)=fLIMNP2(i)-1.0;fMO2(i)=fMO2(i)-1.0;
fHO2(i)=fHO2(i)+  0.7500;fHCHO(i)=fHCHO(i)+  0.7500;fNO2(i)=fNO2(i)+  0.7500;fMOH(i)=fMOH(i)+  0.2500;fHOM(i)=fHOM(i)+  1.0000;
...
% 313, <TRP35>
i=i+1;
Rnames{ 313} = 'APIP2 + ACO3 = 0.50000*HO +  0.50000*MO2 +  0.50000*ORA2 + HOM ';
k(:,i) = (  1.0000E-10 ); 
Gstr{i,   1}='APIP2';Gstr{i,   2}='ACO3';
fAPIP2(i)=fAPIP2(i)-1.0;fACO3(i)=fACO3(i)-1.0;
fHO(i)=fHO(i)+  0.5000;fMO2(i)=fMO2(i)+  0.5000;fORA2(i)=fORA2(i)+  0.5000;fHOM(i)=fHOM(i)+  1.0000;

% 314, <TRP36>
i=i+1;
Rnames{ 314} = 'APINP1 + ACO3 = 0.82500*NO2 +  0.65000*PINAL + MO2 +  0.17500*TRPN +  0.16800*ALD +  0.00700*KET +  0.00700*HCHO +  0.17500*HO2 ';
k(:,i) = (  2.0000E-12.*exp(  5.0000E+02./T) ); 
Gstr{i,   1}='APINP1';Gstr{i,   2}='ACO3';
fAPINP1(i)=fAPINP1(i)-1.0;fACO3(i)=fACO3(i)-1.0;
fNO2(i)=fNO2(i)+  0.8250;fPINAL(i)=fPINAL(i)+  0.6500;fMO2(i)=fMO2(i)+  1.0000;fTRPN(i)=fTRPN(i)+  0.1750;fALD(i)=fALD(i)+  0.1680;fKET(i)=fKET(i)+  0.0070;fHCHO(i)=fHCHO(i)+  0.0070;fHO2(i)=fHO2(i)+  0.1750;

% 315, <TRP37>
i=i+1;
Rnames{ 315} = 'APINP2 + ACO3 = 0.50000*NO2 +  0.50000*MO2 +  0.50000*ORA2 + HOM ';
k(:,i) = (  1.0000E-10 ); 
Gstr{i,   1}='APINP2';Gstr{i,   2}='ACO3';
fAPINP2(i)=fAPINP2(i)-1.0;fACO3(i)=fACO3(i)-1.0;
fNO2(i)=fNO2(i)+  0.5000;fMO2(i)=fMO2(i)+  0.5000;fORA2(i)=fORA2(i)+  0.5000;fHOM(i)=fHOM(i)+  1.0000;
...
% 317, <TRP38>
i=i+1;
Rnames{ 317} = 'LIMP2 + ACO3 = 0.50000*HO +  0.50000*MO2 +  0.50000*ORA2 + HOM ';
k(:,i) = (  1.0000E-10 ); 
...
% 318, <TRP39>
i=i+1;
Rnames{ 318} = 'LIMNP1 + ACO3 = MO2 +  0.46000*NO2 +  0.46000*LIMAL +  0.54000*TRPN +  0.54000*HO2 ';
k(:,i) = (  2.0000E-12.*exp(  5.0000E+02./T) ); 
Gstr{i,   1}='LIMNP1';Gstr{i,   2}='ACO3';
fLIMNP1(i)=fLIMNP1(i)-1.0;fACO3(i)=fACO3(i)-1.0;
fMO2(i)=fMO2(i)+  1.0000;fNO2(i)=fNO2(i)+  0.4600;fLIMAL(i)=fLIMAL(i)+  0.4600;fTRPN(i)=fTRPN(i)+  0.5400;fHO2(i)=fHO2(i)+  0.5400;

% 319, <TRP40>
i=i+1;
Rnames{ 319} = 'LIMNP2 + ACO3 = 0.50000*MO2 +  0.50000*NO2 +  0.50000*ORA2 + HOM ';
k(:,i) = (  1.0000E-10 ); 
Gstr{i,   1}='LIMNP2';Gstr{i,   2}='ACO3';
fLIMNP2(i)=fLIMNP2(i)-1.0;fACO3(i)=fACO3(i)-1.0;
fMO2(i)=fMO2(i)+  0.5000;fNO2(i)=fNO2(i)+  0.5000;fORA2(i)=fORA2(i)+  0.5000;fHOM(i)=fHOM(i)+  1.0000;
...
% 353, <TRP53>
i=i+1;
Rnames{ 353} = 'APINP1 + NO3 = 1.82500*NO2 +  0.65000*PINAL +  0.17500*TRPN +  0.16800*ALD +  0.00700*KET +  0.00700*HCHO +  0.17500*HO2 ';
k(:,i) = (  2.3000E-12 ); 
Gstr{i,   1}='APINP1';Gstr{i,   2}='NO3';
fAPINP1(i)=fAPINP1(i)-1.0;fNO3(i)=fNO3(i)-1.0;
fNO2(i)=fNO2(i)+  1.8250;fPINAL(i)=fPINAL(i)+  0.6500;fTRPN(i)=fTRPN(i)+  0.1750;fALD(i)=fALD(i)+  0.1680;fKET(i)=fKET(i)+  0.0070;fHCHO(i)=fHCHO(i)+  0.0070;fHO2(i)=fHO2(i)+  0.1750;
...
% 378, <TRP41>
i=i+1;
Rnames{ 378} = 'APIP2 + APIP1 = 0.96000*HOM +  0.48000*ROH +  0.48000*PINAL +  0.48000*HO +  0.48000*HO2 +  0.04000*ELHOM ';
k(:,i) = (  1.0000E-10 ); 
Gstr{i,   1}='APIP2';Gstr{i,   2}='APIP1';
fAPIP2(i)=fAPIP2(i)-1.0;fAPIP1(i)=fAPIP1(i)-1.0;
fHOM(i)=fHOM(i)+  0.9600;fROH(i)=fROH(i)+  0.4800;fPINAL(i)=fPINAL(i)+  0.4800;fHO(i)=fHO(i)+  0.4800;fHO2(i)=fHO2(i)+  0.4800;fELHOM(i)=fELHOM(i)+  0.0400;

% 379, <TRP42>
i=i+1;
Rnames{ 379} = 'APIP2 + LIMP1 = 0.96000*HOM +  0.48000*ROH +  0.48000*LIMAL +  0.48000*HO +  0.48000*HO2 +  0.04000*ELHOM ';
k(:,i) = (  1.0000E-10 ); 
Gstr{i,   1}='APIP2';Gstr{i,   2}='LIMP1';
fAPIP2(i)=fAPIP2(i)-1.0;fLIMP1(i)=fLIMP1(i)-1.0;
fHOM(i)=fHOM(i)+  0.9600;fROH(i)=fROH(i)+  0.4800;fLIMAL(i)=fLIMAL(i)+  0.4800;fHO(i)=fHO(i)+  0.4800;fHO2(i)=fHO2(i)+  0.4800;fELHOM(i)=fELHOM(i)+  0.0400;

% 380, <TRP43>
i=i+1;
Rnames{ 380} = 'APIP2 + ISOP = 0.96000*HOM +  0.48000*ROH +  0.48000*HCHO +  0.48000*MVK +  0.48000*HO +  0.48000*HO2 +  0.04000*ELHOM ';
k(:,i) = (  1.0000E-10 ); 
Gstr{i,   1}='APIP2';Gstr{i,   2}='ISOP';
fAPIP2(i)=fAPIP2(i)-1.0;fISOP(i)=fISOP(i)-1.0;
fHOM(i)=fHOM(i)+  0.9600;fROH(i)=fROH(i)+  0.4800;fHCHO(i)=fHCHO(i)+  0.4800;fMVK(i)=fMVK(i)+  0.4800;fHO(i)=fHO(i)+  0.4800;fHO2(i)=fHO2(i)+  0.4800;fELHOM(i)=fELHOM(i)+  0.0400;

% 381, <TRP44>
i=i+1;
Rnames{ 381} = 'LIMP2 + APIP1 = 0.96000*HOM +  0.48000*ROH +  0.48000*PINAL +  0.48000*HO +  0.48000*HO2 +  0.04000*ELHOM ';
k(:,i) = (  1.0000E-10 ); 
...
% 382, <TRP45>
i=i+1;
Rnames{ 382} = 'LIMP2 + LIMP1 = 0.96000*HOM +  0.48000*ROH +  0.48000*LIMAL +  0.48000*HO +  0.48000*HO2 +  0.04000*ELHOM ';
k(:,i) = (  1.0000E-10 ); 
...
% 383, <TRP46>
i=i+1;
Rnames{ 383} = 'LIMP2 + ISOP = 0.96000*HOM +  0.48000*ROH +  0.48000*HCHO +  0.48000*MVK +  0.48000*HO +  0.48000*HO2 +  0.04000*ELHOM ';
k(:,i) = (  1.0000E-10 ); 
...
% 384, <TRP47>
i=i+1;
Rnames{ 384} = 'APINP2 + APIP1 = 0.96000*HOM +  0.48000*ROH +  0.48000*PINAL +  0.48000*NO2 +  0.48000*HO2 +  0.04000*ELHOM ';
k(:,i) = (  1.0000E-10 ); 
Gstr{i,   1}='APINP2';Gstr{i,   2}='APIP1';
fAPINP2(i)=fAPINP2(i)-1.0;fAPIP1(i)=fAPIP1(i)-1.0;
fHOM(i)=fHOM(i)+  0.9600;fROH(i)=fROH(i)+  0.4800;fPINAL(i)=fPINAL(i)+  0.4800;fNO2(i)=fNO2(i)+  0.4800;fHO2(i)=fHO2(i)+  0.4800;fELHOM(i)=fELHOM(i)+  0.0400;

% 385, <TRP48>
i=i+1;
Rnames{ 385} = 'APINP2 + LIMP1 = 0.96000*HOM +  0.48000*ROH +  0.48000*LIMAL +  0.48000*NO2 +  0.48000*HO2 +  0.04000*ELHOM ';
k(:,i) = (  1.0000E-10 ); 
Gstr{i,   1}='APINP2';Gstr{i,   2}='LIMP1';
fAPINP2(i)=fAPINP2(i)-1.0;fLIMP1(i)=fLIMP1(i)-1.0;
fHOM(i)=fHOM(i)+  0.9600;fROH(i)=fROH(i)+  0.4800;fLIMAL(i)=fLIMAL(i)+  0.4800;fNO2(i)=fNO2(i)+  0.4800;fHO2(i)=fHO2(i)+  0.4800;fELHOM(i)=fELHOM(i)+  0.0400;

% 386, <TRP49>
i=i+1;
Rnames{ 386} = 'APINP2 + ISOP = 0.96000*HOM +  0.48000*ROH +  0.48000*HCHO +  0.48000*MVK +  0.48000*NO2 +  0.48000*HO2 +  0.04000*ELHOM ';
k(:,i) = (  1.0000E-10 ); 
Gstr{i,   1}='APINP2';Gstr{i,   2}='ISOP';
fAPINP2(i)=fAPINP2(i)-1.0;fISOP(i)=fISOP(i)-1.0;
fHOM(i)=fHOM(i)+  0.9600;fROH(i)=fROH(i)+  0.4800;fHCHO(i)=fHCHO(i)+  0.4800;fMVK(i)=fMVK(i)+  0.4800;fNO2(i)=fNO2(i)+  0.4800;fHO2(i)=fHO2(i)+  0.4800;fELHOM(i)=fELHOM(i)+  0.0400;

% 387, <TRP50>
i=i+1;
Rnames{ 387} = 'LIMNP2 + APIP1 = 0.96000*HOM +  0.48000*ROH +  0.48000*PINAL +  0.48000*NO2 +  0.48000*HO2 +  0.04000*ELHOM ';
k(:,i) = (  1.0000E-10 ); 
...
% 388, <TRP51>
i=i+1;
Rnames{ 388} = 'LIMNP2 + LIMP1 = 0.96000*HOM +  0.48000*ROH +  0.48000*LIMAL +  0.48000*NO2 +  0.48000*HO2 +  0.04000*ELHOM ';
k(:,i) = (  1.0000E-10 ); 
...
% 389, <TRP52>
i=i+1;
Rnames{ 389} = 'LIMNP2 + ISOP = 0.96000*HOM +  0.48000*ROH +  0.48000*HCHO +  0.48000*MVK +  0.48000*NO2 +  0.48000*HO2 +  0.04000*ELHOM ';
k(:,i) = (  1.0000E-10 ); 
...
% 522, <ROCOXY16c>
i=i+1;
Rnames{ 522} = 'OP3 + HO = HO +  0.11880*VROCN2OXY8 +  0.00080*VROCN2OXY4 +  0.03900*VROCN1OXY6 +  0.01140*VROCP0OXY4 +  0.22660*DCB1 +  0.22660*MEK +  0.22660*ACD +  0.22660*ALD +  0.22660*MO2 +  0.22660*ETHP +  0.22660*HC3P +  0.22660*MEKP ';
k(:,i) = (  4.6900E-11 ); 
Gstr{i,   1}='OP3';Gstr{i,   2}='HO';
fOP3(i)=fOP3(i)-1.0;fHO(i)=fHO(i)-1.0;
