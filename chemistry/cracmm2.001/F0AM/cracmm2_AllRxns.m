...
'VOP3'; 'PAA'; 'ONIT'; 'PAN'; 'VTRPN'; ...
'VHONIT'; 'N2O5'; 'SO2'; 'SULF'; 'SULRXN'; ...
...
'APINP2'; 'LIMNP1'; 'LIMNP2'; 'ADCN'; 'VHOM'; ...
'VROCP4OXY2'; 'VROCN1OXY6'; 'FURANONE'; 'VROCP3OXY2'; 'VROCP0OXY4'; ...
'BAL1'; 'BAL2'; 'VELHOM'; 'VROCIOXY'; 'SLOWROC'; ...
...
fHO2(i)=fHO2(i)+  1.0000;fHC10P(i)=fHC10P(i)+  1.0000;fCO(i)=fCO(i)+  1.0000;
...
Gstr{i,   1}='BALD';
fBALD(i)=fBALD(i)-1.0;
fCHO(i)=fCHO(i)+  1.0000;fHO2(i)=fHO2(i)+  1.0000;fCO(i)=fCO(i)+  1.0000;
...
%  36, <R031>
i=i+1;
Rnames{  36} = 'ONIT = HO2 + NO2 +  0.20000*ALD +  0.80000*KET ';
k(:,i) = (JONIT_RACM2 ); 
Gstr{i,   1}='ONIT';
fONIT(i)=fONIT(i)-1.0;
...
%  38, <R033>
i=i+1;
Rnames{  38} = 'PAN = MO2 + NO3 ';
k(:,i) = (JPAN2_RACM2 ); 
Gstr{i,   1}='PAN';
fPAN(i)=fPAN(i)-1.0;
fMO2(i)=fMO2(i)+  1.0000;fNO3(i)=fNO3(i)+  1.0000;

%  39, <TRP55>
i=i+1;
Rnames{  39} = 'VTRPN = NO2 +  0.67000*KET +  0.33000*UALD ';
k(:,i) = (JONIT_RACM2 ); 
Gstr{i,   1}='VTRPN';
...
%  80, <R073>
i=i+1;
Rnames{  80} = 'HC3 + HO = HC3P +  0.00003*ASOATJ ';
...
%  81, <R074>
i=i+1;
Rnames{  81} = 'HC5 + HO = HC5P +  0.00134*ASOATJ ';
...
%  87, <ROCARO41>
i=i+1;
Rnames{  87} = 'TOL + HO = 0.82000*TOLP +  0.18000*CSL +  0.18000*HO2 ';
...
%  88, <ROCARO51>
i=i+1;
Rnames{  88} = 'XYL + HO = 0.83000*XYLP +  0.17000*CSL +  0.17000*HO2 ';
k(:,i) = (  2.3300E-11 ); 
...
%  89, <ROCARO61>
i=i+1;
Rnames{  89} = 'EBZ + HO = 0.82000*EBZP +  0.18000*CSL +  0.18000*HO2 ';
k(:,i) = (  7.1600E-12 ); 
...
%  90, <RAM01>
i=i+1;
Rnames{  90} = 'ISO + O3 = 0.25000*HO +  0.25000*HO2 +  0.40000*MO2 +  0.01800*ACO3 +  0.10000*MACP +  0.09000*H2O2 +  0.22000*CO + HCHO +  0.30000*MACR +  0.14000*MVK +  0.28000*ORA1 +  0.15300*OLT ';
...
%  91, <RAM02>
i=i+1;
Rnames{  91} = 'ISO + NO3 = 0.40000*NO2 +  0.04500*ISON +  0.35000*HCHO +  0.55500*INO2 +  0.26000*MVK +  0.02800*MACR ';
k(:,i) = (  2.9500E-12.*exp( -4.5000E+02./T) ); 
Gstr{i,   1}='ISO';Gstr{i,   2}='NO3';
fISO(i)=fISO(i)-1.0;fNO3(i)=fNO3(i)-1.0;
fNO2(i)=fNO2(i)+  0.4000;fISON(i)=fISON(i)+  0.0450;fHCHO(i)=fHCHO(i)+  0.3500;fINO2(i)=fINO2(i)+  0.5550;fMVK(i)=fMVK(i)+  0.2600;fMACR(i)=fMACR(i)+  0.0280;

%  92, <RAM03>
i=i+1;
Rnames{  92} = 'ISO + HO = ISOP +  0.25000*HCHO +  0.03000*MACR +  0.05000*MGLY ';
...
%  94, <RAM05>
i=i+1;
Rnames{  94} = 'ISOP + NO = 0.13000*ISON +  0.40000*HCHO +  0.88000*HO2 +  0.87000*NO2 +  0.18000*MACR +  0.51000*MVK ';
...
%  96, <RAM07>
i=i+1;
Rnames{  96} = 'ISHP + HO = 0.04000*MGLY +  0.02000*GLY +  0.13000*MVK +  0.44000*IEPOX +  0.11000*ACO3 +  0.03000*MACR +  2.00000*HO +  0.34000*HO2 +  0.14000*IPX + CO ';
...
%  97, <RAM08>
i=i+1;
Rnames{  97} = 'INO2 + HO2 = 0.45000*HO +  0.95000*INALD +  0.02000*IPX ';
...
%  98, <RAM09>
i=i+1;
Rnames{  98} = 'INO2 + NO = 0.15000*MVK +  0.65000*INALD +  0.05000*ISON +  0.20000*HCHO +  1.30000*NO2 ';
...
%  99, <RAM10>
i=i+1;
Rnames{  99} = 'ISON + HO = HO +  0.35000*INALD +  0.17000*IEPOX +  0.65000*NO2 ';
...
% 100, <RAM11>
i=i+1;
Rnames{ 100} = 'HO + INALD = CO + NO2 +  0.30000*HO2 + HCHO ';
k(:,i) = (  1.5000E-11 ); 
...
% 102, <RAM13>
i=i+1;
Rnames{ 102} = 'IPX + HO = 0.57000*MACR +  0.43000*MVK ';
k(:,i) = (  3.0000E-12 ); 
...
% 105, <TRP04>
i=i+1;
Rnames{ 105} = 'PINAL + HO = 0.23000*PINALP +  0.77000*RCO3 ';
...
% 106, <TRP05>
i=i+1;
Rnames{ 106} = 'LIMAL + HO = 0.83000*LIMALP +  0.17000*RCO3 ';
k(:,i) = (  1.1000E-10 ); 
...
% 116, <R098>
i=i+1;
Rnames{ 116} = 'UALD + HO = 0.31300*ACO3 +  0.68700*UALP ';
...
% 119, <R101>
i=i+1;
Rnames{ 119} = 'DCB1 + HO = 0.52000*HO2 +  0.33000*CO +  0.40000*ALD +  0.78000*KET +  0.10000*GLY +  0.01000*MGLY ';
...
% 120, <R102>
i=i+1;
Rnames{ 120} = 'DCB2 + HO = 0.52000*HO2 +  0.33000*CO +  0.13000*MEK +  0.10000*GLY +  0.01000*MGLY +  0.78000*OP2 ';
k(:,i) = (  2.8000E-11.*exp(  1.7500E+02./T) ); 
...
% 121, <R103>
i=i+1;
Rnames{ 121} = 'DCB3 + HO = 0.56000*HO2 +  0.21000*MACP +  0.11000*CO +  0.27000*GLY +  0.01000*MGLY +  0.79000*OP2 ';
k(:,i) = (  1.0000E-11 ); 
...
% 123, <R105>
i=i+1;
Rnames{ 123} = 'PHEN + HO = 0.15200*ASOATJ +  0.61900*HO2 +  0.17000*ADDC +  0.05900*CHO +  0.61900*MCT ';
...
% 124, <R106>
i=i+1;
Rnames{ 124} = 'CSL + HO = 0.20000*ASOATJ +  0.58400*HO2 +  0.16000*ADDC +  0.05600*CHO +  0.58400*MCT ';
...
% 128, <R111>
i=i+1;
Rnames{ 128} = 'ROH + HO = HO2 +  0.71900*ALD +  0.18400*ACD ';
...
% 129, <R112>
i=i+1;
Rnames{ 129} = 'ETEG + HO = HO2 + ALD ';
k(:,i) = (  1.4700E-11 ); 
Gstr{i,   1}='ETEG';Gstr{i,   2}='HO';
fETEG(i)=fETEG(i)-1.0;fHO(i)=fHO(i)-1.0;
fHO2(i)=fHO2(i)+  1.0000;fALD(i)=fALD(i)+  1.0000;
...
% 131, <R114>
i=i+1;
Rnames{ 131} = 'OP2 + HO = 0.01000*HO +  0.44000*HC3P +  0.07000*XO2 +  0.08000*ALD +  0.41000*KET ';
...
% 132, <TRP06>
i=i+1;
Rnames{ 132} = 'OPB + HO = 0.01000*HO +  0.44000*HC10P +  0.07000*XO2 +  0.08000*ALD +  0.41000*KET ';
k(:,i) = (  3.4000E-12.*exp(  1.9000E+02./T) ); 
...
% 133, <R114a>
i=i+1;
Rnames{ 133} = 'VOP3 + HO = 0.01000*HO +  0.44000*HC10P +  0.07000*XO2 +  0.08000*ALD +  0.41000*KET ';
k(:,i) = (  3.4000E-12.*exp(  1.9000E+02./T) ); 
...
% 136, <R118>
i=i+1;
Rnames{ 136} = 'ORA2 + HO = 0.64000*MO2 +  0.36000*ORAP ';
k(:,i) = (  4.0000E-14.*exp(  8.5000E+02./T) ); 
Gstr{i,   1}='ORA2';Gstr{i,   2}='HO';
fORA2(i)=fORA2(i)-1.0;fHO(i)=fHO(i)-1.0;
fMO2(i)=fMO2(i)+  0.6400;fORAP(i)=fORAP(i)+  0.3600;

% 137, <R119>
i=i+1;
Rnames{ 137} = 'PAA + HO = 0.35000*HO +  0.65000*ACO3 +  0.35000*XO2 +  0.35000*HCHO ';
...
% 138, <R120>
i=i+1;
Rnames{ 138} = 'PAN + HO = XO2 + NO3 + HCHO ';
k(:,i) = (  4.0000E-14 ); 
...
% 139, <R121>
i=i+1;
Rnames{ 139} = 'PPN + HO = XO2 + NO3 + HCHO ';
k(:,i) = (  4.0000E-14 ); 
...
% 140, <R122>
i=i+1;
Rnames{ 140} = 'MPAN + HO = NO2 + HKET ';
k(:,i) = (  3.2000E-11 ); 
Gstr{i,   1}='MPAN';Gstr{i,   2}='HO';
fMPAN(i)=fMPAN(i)-1.0;fHO(i)=fHO(i)-1.0;
fNO2(i)=fNO2(i)+  1.0000;fHKET(i)=fHKET(i)+  1.0000;

% 141, <R123>
i=i+1;
Rnames{ 141} = 'ONIT + HO = HC3P + NO2 ';
...
% 142, <TRP07>
i=i+1;
Rnames{ 142} = 'VTRPN + HO = 0.33000*VHONIT +  0.67000*NO2 +  0.27000*PINAL +  0.38000*KET +  0.21000*HCHO +  0.02000*ALD ';
k(:,i) = (  4.8000E-12 ); 
...
% 144, <R126>
i=i+1;
Rnames{ 144} = 'ETE + O3 = 0.08000*HO +  0.15000*HO2 +  0.43000*CO + HCHO +  0.37000*ORA1 ';
k(:,i) = (  9.1400E-15.*exp( -2.5800E+03./T) ); 
Gstr{i,   1}='ETE';Gstr{i,   2}='O3';
fETE(i)=fETE(i)-1.0;fO3(i)=fO3(i)-1.0;
fHO(i)=fHO(i)+  0.0800;fHO2(i)=fHO2(i)+  0.1500;fCO(i)=fCO(i)+  0.4300;fHCHO(i)=fHCHO(i)+  1.0000;fORA1(i)=fORA1(i)+  0.3700;

% 145, <R127>
i=i+1;
Rnames{ 145} = 'OLT + O3 = 0.22000*HO +  0.32000*HO2 +  0.08000*MO2 +  0.06000*ETHP +  0.04000*HC3P +  0.02000*HC5P +  0.06800*H2O2 +  0.43000*CO +  0.02000*ETH +  0.01500*HC3 +  0.00600*HC5 +  0.03200*BEN +  0.56000*HCHO +  0.01000*ACD +  0.44000*ALD +  0.03000*ACT +  0.02000*BALD +  0.06000*MEK +  0.01000*HKET +  0.03000*ORA1 +  0.06000*ORA2 ';
...
% 146, <R128>
i=i+1;
Rnames{ 146} = 'OLI + O3 = 0.46000*HO +  0.07000*HO2 +  0.32000*MO2 +  0.07000*ETHP +  0.04000*HC3P +  0.09000*ACO3 +  0.37000*CO +  0.02600*H2O2 +  0.01000*ETH +  0.01000*HC3 +  0.09000*HCHO +  0.45700*ACD +  0.73000*ALD +  0.11000*ACT +  0.01700*KET +  0.04400*HKET +  0.01700*ORA2 ';
...
% 147, <R131>
i=i+1;
Rnames{ 147} = 'API + O3 = 0.60550*HO +  0.21450*PINALP +  0.25500*H2O2 +  0.25350*PINAL +  0.00650*ORA2 +  0.11050*HO2 +  0.11050*CO +  0.45900*HCHO +  0.28050*RCO3 +  0.17850*KET +  0.06650*HC3 +  0.03850*OP1 +  0.02800*ORA1 ';
k(:,i) = (  8.0500E-16.*exp( -6.4000E+02./T) ); 
Gstr{i,   1}='API';Gstr{i,   2}='O3';
fAPI(i)=fAPI(i)-1.0;fO3(i)=fO3(i)-1.0;
fHO(i)=fHO(i)+  0.6055;fPINALP(i)=fPINALP(i)+  0.2145;fH2O2(i)=fH2O2(i)+  0.2550;fPINAL(i)=fPINAL(i)+  0.2535;fORA2(i)=fORA2(i)+  0.0065;fHO2(i)=fHO2(i)+  0.1105;fCO(i)=fCO(i)+  0.1105;fHCHO(i)=fHCHO(i)+  0.4590;fRCO3(i)=fRCO3(i)+  0.2805;fKET(i)=fKET(i)+  0.1785;fHC3(i)=fHC3(i)+  0.0665;fOP1(i)=fOP1(i)+  0.0385;fORA1(i)=fORA1(i)+  0.0280;

% 148, <R132>
i=i+1;
Rnames{ 148} = 'LIM + O3 = 0.66000*HO +  0.66000*LIMAL +  0.33000*ACO3 +  0.33000*HCHO +  0.33000*RCO3 +  0.33000*H2O2 +  0.01000*ORA2 ';
k(:,i) = (  2.8000E-15.*exp( -7.7000E+02./T) ); 
Gstr{i,   1}='LIM';Gstr{i,   2}='O3';
fLIM(i)=fLIM(i)-1.0;fO3(i)=fO3(i)-1.0;
fHO(i)=fHO(i)+  0.6600;fLIMAL(i)=fLIMAL(i)+  0.6600;fACO3(i)=fACO3(i)+  0.3300;fHCHO(i)=fHCHO(i)+  0.3300;fRCO3(i)=fRCO3(i)+  0.3300;fH2O2(i)=fH2O2(i)+  0.3300;fORA2(i)=fORA2(i)+  0.0100;

% 149, <TRP08>
i=i+1;
Rnames{ 149} = 'LIMAL + O3 = 0.09000*HO + ALD +  0.62000*HCHO +  0.23000*OP1 +  0.02000*H2O2 +  0.15000*ORA1 ';
k(:,i) = (  8.3000E-18 ); 
...
% 150, <TRP09>
i=i+1;
Rnames{ 150} = 'VTRPN + O3 = 0.33000*VHONIT +  0.67000*NO2 +  0.27000*PINAL +  0.38000*KET +  0.21000*HCHO +  0.02000*ALD ';
k(:,i) = (  1.6700E-16 ); 
...
% 151, <R133>
i=i+1;
Rnames{ 151} = 'MACR + O3 = 0.19000*HO +  0.14000*HO2 +  0.10000*ACO3 +  0.22000*CO +  0.50000*MGLY +  0.45000*ORA1 ';
...
% 152, <R134>
i=i+1;
Rnames{ 152} = 'MVK + O3 = 0.16000*HO +  0.11000*HO2 +  0.28000*ACO3 +  0.01000*XO2 +  0.56000*CO +  0.10000*HCHO +  0.54000*MGLY +  0.07000*ORA1 +  0.07000*ORA2 +  0.10000*ALD ';
...
% 153, <R135>
i=i+1;
Rnames{ 153} = 'UALD + O3 = 0.10000*HO +  0.07200*HO2 +  0.00800*MO2 +  0.00200*ACO3 +  0.10000*XO2 +  0.24300*CO +  0.08000*HCHO +  0.42000*ACD +  0.02800*KET +  0.49100*GLY +  0.00300*MGLY +  0.04400*ORA1 ';
k(:,i) = (  1.6600E-18 ); 
...
% 154, <R136>
i=i+1;
Rnames{ 154} = 'DCB1 + O3 = 0.05000*HO + HO2 +  0.60000*RCO3 +  0.60000*XO2 +  1.50000*CO +  0.05000*HCHO +  0.05000*GLY +  0.08000*MGLY +  0.65000*OP2 ';
k(:,i) = (  2.0000E-16 ); 
Gstr{i,   1}='DCB1';Gstr{i,   2}='O3';
fDCB1(i)=fDCB1(i)-1.0;fO3(i)=fO3(i)-1.0;
fHO(i)=fHO(i)+  0.0500;fHO2(i)=fHO2(i)+  1.0000;fRCO3(i)=fRCO3(i)+  0.6000;fXO2(i)=fXO2(i)+  0.6000;fCO(i)=fCO(i)+  1.5000;fHCHO(i)=fHCHO(i)+  0.0500;fGLY(i)=fGLY(i)+  0.0500;fMGLY(i)=fMGLY(i)+  0.0800;fOP2(i)=fOP2(i)+  0.6500;

% 155, <R137>
i=i+1;
Rnames{ 155} = 'DCB2 + O3 = 0.05000*HO + HO2 +  0.60000*RCO3 +  0.60000*XO2 +  1.50000*CO +  0.05000*HCHO +  0.05000*GLY +  0.08000*MGLY +  0.70000*DCB1 +  0.65000*OP2 ';
k(:,i) = (  2.0000E-16 ); 
Gstr{i,   1}='DCB2';Gstr{i,   2}='O3';
fDCB2(i)=fDCB2(i)-1.0;fO3(i)=fO3(i)-1.0;
fHO(i)=fHO(i)+  0.0500;fHO2(i)=fHO2(i)+  1.0000;fRCO3(i)=fRCO3(i)+  0.6000;fXO2(i)=fXO2(i)+  0.6000;fCO(i)=fCO(i)+  1.5000;fHCHO(i)=fHCHO(i)+  0.0500;fGLY(i)=fGLY(i)+  0.0500;fMGLY(i)=fMGLY(i)+  0.0800;fDCB1(i)=fDCB1(i)+  0.7000;fOP2(i)=fOP2(i)+  0.6500;

% 156, <R138>
i=i+1;
Rnames{ 156} = 'DCB3 + O3 = 0.05000*HO + HO2 +  1.50000*CO +  0.48000*GLY +  0.70000*DCB1 +  0.25000*ORA1 +  0.25000*ORA2 +  0.11000*PAA ';
k(:,i) = (  9.0000E-17 ); 
Gstr{i,   1}='DCB3';Gstr{i,   2}='O3';
fDCB3(i)=fDCB3(i)-1.0;fO3(i)=fO3(i)-1.0;
fHO(i)=fHO(i)+  0.0500;fHO2(i)=fHO2(i)+  1.0000;fCO(i)=fCO(i)+  1.5000;fGLY(i)=fGLY(i)+  0.4800;fDCB1(i)=fDCB1(i)+  0.7000;fORA1(i)=fORA1(i)+  0.2500;fORA2(i)=fORA2(i)+  0.2500;fPAA(i)=fPAA(i)+  0.1100;
...
% 158, <R141>
i=i+1;
Rnames{ 158} = 'ETE + NO3 = 0.80000*OLNN +  0.20000*OLND ';
...
% 160, <R143>
i=i+1;
Rnames{ 160} = 'OLI + NO3 = 0.11000*OLNN +  0.89000*OLND ';
...
% 163, <TRP10>
i=i+1;
Rnames{ 163} = 'VTRPN + NO3 = 0.33000*VHONIT +  0.67000*NO2 +  0.27000*PINAL +  0.38000*KET +  0.21000*HCHO +  0.02000*ALD ';
...
% 168, <R152>
i=i+1;
Rnames{ 168} = 'UALD + NO3 = HO2 + XO2 +  0.66800*CO +  0.33200*HCHO +  0.33200*ALD + ONIT ';
...
% 171, <R155>
i=i+1;
Rnames{ 171} = 'PHEN + NO3 = 0.15200*ASOATJ +  0.33900*CHO +  0.85000*ADDC +  0.42400*ADCN +  0.42400*HNO3 ';
k(:,i) = (  3.7800E-12 ); 
...
% 172, <R156>
i=i+1;
Rnames{ 172} = 'CSL + NO3 = 0.20000*ASOATJ +  0.32000*CHO +  0.08000*ADDC +  0.40000*ADCN +  0.40000*HNO3 ';
k(:,i) = (  1.0600E-12 ); 
...
% 185, <R174>
i=i+1;
Rnames{ 185} = 'HC3P + NO = 0.66000*HO2 +  0.13100*MO2 +  0.04800*ETHP +  0.08900*XO2 +  0.93500*NO2 +  0.50400*ACD +  0.13200*ALD +  0.16500*ACT +  0.04200*MEK +  0.06500*ONIT ';
k(:,i) = (  4.0000E-12 ); 
...
% 186, <R175>
i=i+1;
Rnames{ 186} = 'HC5P + NO = 0.20000*HO2 +  0.05100*MO2 +  0.23100*ETHP +  0.23500*XO2 +  0.86400*NO2 +  0.01800*HCHO +  0.04500*ACD +  0.20300*ALD +  0.03300*MEK +  0.21700*ACT +  0.03300*KET +  0.27200*HKET +  0.13600*ONIT ';
k(:,i) = (  4.0000E-12 ); 
...
% 187, <R177>
i=i+1;
Rnames{ 187} = 'ETEP + NO = HO2 + NO2 +  1.60000*HCHO +  0.20000*ALD ';
k(:,i) = (  9.0000E-12 ); 
...
% 188, <R178>
i=i+1;
Rnames{ 188} = 'OLTP + NO = 0.78000*HO2 +  0.97000*NO2 +  0.78000*HCHO +  0.01200*ACD +  0.44000*ALD +  0.06000*ACT +  0.13000*MEK +  0.03000*ONIT ';
k(:,i) = (  4.0000E-12 ); 
...
% 189, <R179>
i=i+1;
Rnames{ 189} = 'OLIP + NO = 0.83000*HO2 +  0.95000*NO2 +  0.81000*ACD +  0.68000*ALD +  0.20000*ACT +  0.09000*KET +  0.02000*HKET +  0.05000*ONIT ';
k(:,i) = (  4.0000E-12 ); 
...
% 190, <ROCARO33>
i=i+1;
Rnames{ 190} = 'BENP + NO = 0.00000*ONIT +  0.00120*VROCP4OXY2 +  0.00080*VROCN1OXY6 +  0.99800*NO2 +  0.99800*HO2 +  0.00000*BALD +  0.99800*GLY +  0.49900*FURANONE +  0.24950*DCB2 +  0.24950*DCB3 ';
...
% 191, <ROCARO43>
i=i+1;
Rnames{ 191} = 'TOLP + NO = 0.00020*ONIT +  0.00130*VROCP4OXY2 +  0.00060*VROCN1OXY6 +  0.99800*NO2 +  0.99800*HO2 +  0.08520*BALD +  0.54770*GLY +  0.36510*MGLY +  0.36510*FURANONE +  0.54770*DCB1 ';
k(:,i) = (  2.7000E-12.*exp(  3.6000E+02./T) ); 
...
% 192, <ROCARO53>
i=i+1;
Rnames{ 192} = 'XYLP + NO = 0.00010*ONIT +  0.00130*VROCP3OXY2 +  0.00060*VROCP0OXY4 +  0.99800*NO2 +  0.99800*HO2 +  0.04810*BALD +  0.70290*GLY +  0.24700*MGLY +  0.35150*FURANONE +  0.59840*DCB2 ';
k(:,i) = (  2.7000E-12.*exp(  3.6000E+02./T) ); 
...
% 193, <ROCARO63>
i=i+1;
Rnames{ 193} = 'EBZP + NO = 0.00020*ONIT +  0.00130*VROCP3OXY2 +  0.00060*VROCP0OXY4 +  0.99800*NO2 +  0.99800*HO2 +  0.08520*BALD +  0.54770*GLY +  0.36510*MGLY +  0.45640*FURANONE +  0.45640*DCB2 ';
k(:,i) = (  2.7000E-12.*exp(  3.6000E+02./T) ); 
...
% 194, <R189>
i=i+1;
Rnames{ 194} = 'APIP1 + NO = 0.23700*VTRPN +  0.76300*HO2 +  0.76300*NO2 +  0.19500*PINAL +  0.28400*ALD +  0.08650*ACT +  0.12850*LIMAL +  0.30800*HCHO +  0.07150*OPB +  0.08400*KET ';
k(:,i) = (  2.7000E-12.*exp(  3.6000E+02./T) ); 
...
% 195, <TRP13>
i=i+1;
Rnames{ 195} = 'APIP2 + NO = 0.82000*HO +  0.82000*NO2 + VHOM ';
k(:,i) = (  4.0000E-12 ); 
...
% 196, <TRP14>
i=i+1;
Rnames{ 196} = 'APINP1 + NO = 1.69550*NO2 +  0.23450*VTRPN +  0.07000*ONIT +  0.60450*PINAL +  0.15400*ALD +  0.00700*KET +  0.00700*HCHO +  0.16450*HO2 ';
k(:,i) = (  2.7000E-12.*exp(  3.6000E+02./T) ); 
...
% 197, <TRP15>
i=i+1;
Rnames{ 197} = 'APINP2 + NO = 0.82000*NO2 +  0.82000*HO + VHOM ';
k(:,i) = (  4.0000E-12 ); 
...
% 198, <R190>
i=i+1;
Rnames{ 198} = 'LIMP1 + NO = 0.23000*VTRPN +  0.77000*NO2 +  0.77000*LIMAL +  0.77000*HO2 +  0.43000*HCHO ';
k(:,i) = (  2.7000E-12.*exp(  3.6000E+02./T) ); 
...
% 199, <TRP16>
i=i+1;
Rnames{ 199} = 'LIMP2 + NO = 0.77000*HO +  0.77000*NO2 + VHOM ';
k(:,i) = (  4.0000E-12 ); 
...
% 200, <TRP17>
i=i+1;
Rnames{ 200} = 'LIMNP1 + NO = 0.57000*VTRPN +  0.07000*ONIT +  1.36000*NO2 +  0.43000*LIMAL +  0.50000*HO2 ';
k(:,i) = (  2.7000E-12.*exp(  3.6000E+02./T) ); 
...
% 201, <TRP18>
i=i+1;
Rnames{ 201} = 'LIMNP2 + NO = 0.77000*NO2 +  0.77000*HO + VHOM ';
k(:,i) = (  4.0000E-12 ); 
...
% 202, <TRP19>
i=i+1;
Rnames{ 202} = 'PINALP + NO = 0.36000*VTRPN +  0.64000*VHOM +  0.64000*NO2 ';
k(:,i) = (  2.7000E-12.*exp(  3.6000E+02./T) ); 
...
% 203, <TRP20>
i=i+1;
Rnames{ 203} = 'LIMALP + NO = 0.64000*VTRPN +  0.36000*NO2 +  0.36000*HO2 +  0.36000*HCHO +  0.36000*PAA ';
k(:,i) = (  2.7000E-12.*exp(  3.6000E+02./T) ); 
...
% 204, <R191>
i=i+1;
Rnames{ 204} = 'ACO3 + NO = MO2 + NO2 ';
k(:,i) = (  8.1000E-12.*exp(  2.7000E+02./T) ); 
Gstr{i,   1}='ACO3';Gstr{i,   2}='NO';
fACO3(i)=fACO3(i)-1.0;fNO(i)=fNO(i)-1.0;
fMO2(i)=fMO2(i)+  1.0000;fNO2(i)=fNO2(i)+  1.0000;

% 205, <R192>
i=i+1;
Rnames{ 205} = 'RCO3 + NO = ETHP + NO2 ';
k(:,i) = (  8.1000E-12.*exp(  2.7000E+02./T) ); 
...
% 207, <R194>
i=i+1;
Rnames{ 207} = 'MEKP + NO = 0.67000*HO2 + NO2 +  0.33000*HCHO +  0.67000*DCB1 ';
k(:,i) = (  4.0000E-12 ); 
...
% 208, <R195>
i=i+1;
Rnames{ 208} = 'KETP + NO = 0.77000*HO2 +  0.23000*ACO3 +  0.16000*XO2 + NO2 +  0.46000*ALD +  0.54000*MGLY ';
k(:,i) = (  4.0000E-12 ); 
...
% 209, <R196>
i=i+1;
Rnames{ 209} = 'MACP + NO = 0.65000*MO2 +  0.35000*ACO3 + NO2 +  0.65000*CO +  0.65000*HCHO ';
...
% 210, <R197>
i=i+1;
Rnames{ 210} = 'MCP + NO = NO2 +  0.50000*HO2 +  0.50000*HCHO + HKET ';
k(:,i) = (  2.5400E-12.*exp(  3.6000E+02./T) ); 
...
% 211, <R198>
i=i+1;
Rnames{ 211} = 'MVKP + NO = 0.30000*HO2 +  0.70000*ACO3 +  0.70000*XO2 + NO2 +  0.30000*HCHO +  0.70000*ALD +  0.30000*MGLY ';
k(:,i) = (  2.5400E-12.*exp(  3.6000E+02./T) ); 
...
% 212, <R199>
i=i+1;
Rnames{ 212} = 'UALP + NO = HO2 + NO2 +  0.61000*CO +  0.03000*HCHO +  0.27000*ALD +  0.18000*GLY +  0.70000*KET +  0.21000*MGLY ';
k(:,i) = (  2.5400E-12.*exp(  3.6000E+02./T) ); 
...
% 215, <R202>
i=i+1;
Rnames{ 215} = 'ADDC + NO = HO2 + NO2 +  0.32000*HKET +  0.68000*GLY +  0.68000*OP2 ';
k(:,i) = (  2.7000E-12.*exp(  3.6000E+02./T) ); 
...
% 218, <R205>
i=i+1;
Rnames{ 218} = 'OLNN + NO = NO2 + HO2 + ONIT ';
k(:,i) = (  4.0000E-12 ); 
...
% 219, <R206>
i=i+1;
Rnames{ 219} = 'OLND + NO = 2.00000*NO2 +  0.28700*HCHO +  1.24000*ALD +  0.46400*KET ';
k(:,i) = (  4.0000E-12 ); 
...
% 220, <R207>
i=i+1;
Rnames{ 220} = 'ADCN + NO = 2.00000*NO2 + GLY + OP2 ';
k(:,i) = (  2.7000E-12.*exp(  3.6000E+02./T) ); 
...
% 232, <ROCARO32>
i=i+1;
Rnames{ 232} = 'BENP + HO2 = 0.60210*OP2 +  0.39790*VROCN1OXY6 ';
...
% 233, <ROCARO42>
i=i+1;
Rnames{ 233} = 'TOLP + HO2 = 0.71950*OP2 +  0.28050*VROCN1OXY6 ';
k(:,i) = (  2.9100E-13.*exp(  1.3000E+03./T) ); 
...
% 234, <ROCARO52>
i=i+1;
Rnames{ 234} = 'XYLP + HO2 = 0.04820*OP2 +  0.67470*VOP3 +  0.27710*VROCP0OXY4 ';
k(:,i) = (  2.9100E-13.*exp(  1.3000E+03./T) ); 
...
% 235, <ROCARO62>
i=i+1;
Rnames{ 235} = 'EBZP + HO2 = 0.08540*OP2 +  0.63410*VOP3 +  0.28050*VROCP0OXY4 ';
k(:,i) = (  2.9100E-13.*exp(  1.3000E+03./T) ); 
...
% 236, <R229>
i=i+1;
Rnames{ 236} = 'APIP1 + HO2 = 0.03900*ACT +  0.03900*LIMAL +  0.06250*HCHO +  0.76200*OPB +  0.32250*HO2 +  0.18850*PINAL +  0.23800*HO +  0.01050*KET ';
...
% 238, <TRP22>
i=i+1;
Rnames{ 238} = 'APINP1 + HO2 = 0.46100*VTRPN +  0.45500*PINAL +  0.53900*NO2 +  0.61950*HO +  0.07700*ALD +  0.00700*KET +  0.00700*HCHO ';
...
% 240, <R230>
i=i+1;
Rnames{ 240} = 'LIMP1 + HO2 = 0.90000*OPB +  0.10000*LIMAL +  0.10000*HO +  0.10000*HO2 +  0.06000*HCHO ';
k(:,i) = (  2.6000E-13.*exp(  1.3000E+03./T) ); 
...
% 242, <TRP25>
i=i+1;
Rnames{ 242} = 'LIMNP1 + HO2 = 0.77000*VTRPN +  0.50000*HO +  0.23000*LIMAL +  0.23000*NO2 +  0.27000*HO2 ';
k(:,i) = (  2.7100E-13.*exp(  1.3000E+03./T) ); 
...
% 244, <TRP27>
i=i+1;
Rnames{ 244} = 'PINALP + HO2 = 0.75000*OPB +  0.25000*HO +  0.25000*VHOM ';
k(:,i) = (  2.7100E-13.*exp(  1.3000E+03./T) ); 
...
% 245, <TRP28>
i=i+1;
Rnames{ 245} = 'LIMALP + HO2 = 0.90000*OPB +  0.10000*HO +  0.10000*HO2 +  0.10000*HCHO +  0.10000*PAA ';
...
% 246, <R231>
i=i+1;
Rnames{ 246} = 'ACO3 + HO2 = 0.44000*HO +  0.44000*MO2 +  0.15000*ORA2 +  0.41000*PAA ';
k(:,i) = (  4.3000E-13.*exp(  1.0400E+03./T) ); 
Gstr{i,   1}='ACO3';Gstr{i,   2}='HO2';
fACO3(i)=fACO3(i)-1.0;fHO2(i)=fHO2(i)-1.0;
fHO(i)=fHO(i)+  0.4400;fMO2(i)=fMO2(i)+  0.4400;fORA2(i)=fORA2(i)+  0.1500;fPAA(i)=fPAA(i)+  0.4100;

% 247, <R232>
i=i+1;
Rnames{ 247} = 'RCO3 + HO2 = 0.44000*HO +  0.44000*ETHP +  0.15000*ORA2 +  0.41000*PAA ';
k(:,i) = (  4.3000E-13.*exp(  1.0400E+03./T) ); 
Gstr{i,   1}='RCO3';Gstr{i,   2}='HO2';
fRCO3(i)=fRCO3(i)-1.0;fHO2(i)=fHO2(i)-1.0;
fHO(i)=fHO(i)+  0.4400;fETHP(i)=fETHP(i)+  0.4400;fORA2(i)=fORA2(i)+  0.1500;fPAA(i)=fPAA(i)+  0.4100;

% 248, <R233>
i=i+1;
Rnames{ 248} = 'ACTP + HO2 = 0.15000*HO +  0.15000*ACO3 +  0.15000*HCHO +  0.85000*OP2 ';
...
% 265, <R250>
i=i+1;
Rnames{ 265} = 'HC3P + MO2 = 0.89400*HO2 +  0.08000*MO2 +  0.02600*ETHP +  0.02600*XO2 +  0.82700*HCHO +  0.19800*ALD +  0.49700*KET +  0.05000*GLY +  0.25000*MOH +  0.25000*ROH ';
...
% 266, <R251>
i=i+1;
Rnames{ 266} = 'HC5P + MO2 = 0.84200*HO2 +  0.01800*MO2 +  0.14000*ETHP +  0.19100*XO2 +  0.77700*HCHO +  0.25100*ALD +  0.61800*KET +  0.25000*MOH +  0.25000*ROH ';
...
% 267, <R253>
i=i+1;
Rnames{ 267} = 'ETEP + MO2 = HO2 +  1.95000*HCHO +  0.15000*ALD +  0.25000*MOH +  0.25000*ETEG ';
...
% 268, <R254>
i=i+1;
Rnames{ 268} = 'OLTP + MO2 = HO2 +  1.50000*HCHO +  0.70500*ALD +  0.04500*KET +  0.25000*MOH +  0.25000*ROH ';
...
% 269, <R255>
i=i+1;
Rnames{ 269} = 'OLIP + MO2 = HO2 +  0.75000*HCHO +  1.28000*ALD +  0.21800*KET +  0.25000*MOH +  0.25000*ROH ';
...
% 270, <ROCARO35>
i=i+1;
Rnames{ 270} = 'BENP + MO2 = 0.68000*HCHO +  1.37000*HO2 +  0.32000*MOH +  0.00000*BALD + GLY +  0.50000*FURANONE +  0.25000*DCB2 +  0.25000*DCB3 ';
...
% 271, <ROCARO45>
i=i+1;
Rnames{ 271} = 'TOLP + MO2 = 0.68000*HCHO +  1.28460*HO2 +  0.32000*MOH +  0.08540*BALD +  0.54880*GLY +  0.36590*MGLY +  0.36590*FURANONE +  0.54880*DCB1 ';
k(:,i) = (  3.5600E-14.*exp(  7.0800E+02./T) ); 
...
% 272, <ROCARO55>
i=i+1;
Rnames{ 272} = 'XYLP + MO2 = 0.68000*HCHO +  1.32180*HO2 +  0.32000*MOH +  0.04820*BALD +  0.70430*GLY +  0.24750*MGLY +  0.35220*FURANONE +  0.59960*DCB2 ';
k(:,i) = (  3.5600E-14.*exp(  7.0800E+02./T) ); 
...
% 273, <ROCARO65>
i=i+1;
Rnames{ 273} = 'EBZP + MO2 = 0.68000*HCHO +  1.28460*HO2 +  0.32000*MOH +  0.08540*BALD +  0.54880*GLY +  0.36590*MGLY +  0.45730*FURANONE +  0.45730*DCB2 ';
k(:,i) = (  3.5600E-14.*exp(  7.0800E+02./T) ); 
...
% 274, <R264>
i=i+1;
Rnames{ 274} = 'ISOP + MO2 = HO2 +  1.31000*HCHO +  0.15900*MACR +  0.25000*MVK +  0.25000*MOH +  0.25000*ROH +  0.02300*ALD +  0.01800*GLY +  0.01600*HKET ';
...
% 275, <R265>
i=i+1;
Rnames{ 275} = 'APIP1 + MO2 = 1.02950*HCHO +  0.22050*LIMAL +  0.27300*PINAL +  0.23850*ALD +  0.08450*OPB +  0.11050*MOH +  0.18350*KET +  0.06700*ACT +  1.27900*HO2 ';
k(:,i) = (  2.0000E-12 ); 
...
% 276, <TRP29>
i=i+1;
Rnames{ 276} = 'APIP2 + MO2 = HO2 +  0.75000*HCHO +  0.25000*MOH + VHOM ';
k(:,i) = (  1.0000E-10 ); 
...
% 277, <TRP30>
i=i+1;
Rnames{ 277} = 'APINP1 + MO2 = 0.34100*VTRPN +  0.96400*HCHO +  0.04300*MOH +  0.91800*HO2 +  0.65900*NO2 +  0.53300*PINAL +  0.00700*KET +  0.11900*ALD ';
k(:,i) = (  2.0000E-12 ); 
...
% 278, <TRP31>
i=i+1;
Rnames{ 278} = 'APINP2 + MO2 = 0.75000*HO2 +  0.75000*NO2 +  0.25000*MOH +  0.75000*HCHO + VHOM ';
k(:,i) = (  1.0000E-10 ); 
...
% 279, <R266>
i=i+1;
Rnames{ 279} = 'LIMP1 + MO2 = 0.25000*MOH + LIMAL +  1.03000*HCHO + HO2 ';
k(:,i) = (  2.0000E-12 ); 
...
% 280, <TRP32>
i=i+1;
Rnames{ 280} = 'LIMP2 + MO2 = HO2 +  0.75000*HCHO +  0.25000*MOH + VHOM ';
k(:,i) = (  1.0000E-10 ); 
...
% 281, <TRP33>
i=i+1;
Rnames{ 281} = 'LIMNP1 + MO2 = 0.69000*VTRPN +  0.91000*HCHO +  0.09000*MOH +  1.01000*HO2 +  0.31000*LIMAL +  0.31000*NO2 ';
k(:,i) = (  2.0000E-12 ); 
...
% 282, <TRP34>
i=i+1;
Rnames{ 282} = 'LIMNP2 + MO2 = 0.75000*HO2 +  0.75000*HCHO +  0.75000*NO2 +  0.25000*MOH + VHOM ';
k(:,i) = (  1.0000E-10 ); 
...
% 283, <R267>
i=i+1;
Rnames{ 283} = 'ACO3 + MO2 = 0.90000*HO2 +  0.90000*MO2 + HCHO +  0.10000*ORA2 ';
k(:,i) = (  2.0000E-11.*exp(  5.0000E+02./T) ); 
Gstr{i,   1}='ACO3';Gstr{i,   2}='MO2';
fACO3(i)=fACO3(i)-1.0;fMO2(i)=fMO2(i)-1.0;
fHO2(i)=fHO2(i)+  0.9000;fMO2(i)=fMO2(i)+  0.9000;fHCHO(i)=fHCHO(i)+  1.0000;fORA2(i)=fORA2(i)+  0.1000;

% 284, <R268>
i=i+1;
Rnames{ 284} = 'RCO3 + MO2 = 0.90000*HO2 +  0.90000*MO2 + HCHO +  0.10000*ORA2 ';
k(:,i) = (  2.0000E-11.*exp(  5.0000E+02./T) ); 
...
% 285, <R269>
i=i+1;
Rnames{ 285} = 'ACTP + MO2 = 0.50000*HO2 +  0.50000*ACO3 +  1.50000*HCHO +  0.25000*MOH +  0.25000*ROH +  0.12500*ORA2 ';
...
% 286, <R270>
i=i+1;
Rnames{ 286} = 'MEKP + MO2 = 0.83400*HO2 + HCHO +  0.33400*DCB1 +  0.25000*MOH +  0.25000*ROH ';
...
% 287, <R271>
i=i+1;
Rnames{ 287} = 'KETP + MO2 = HO2 +  0.75000*HCHO +  0.50000*DCB1 +  0.25000*MOH +  0.25000*ROH ';
k(:,i) = (  6.9100E-13.*exp(  5.0800E+02./T) ); 
...
% 288, <R272>
i=i+1;
Rnames{ 288} = 'MACP + MO2 = 0.50000*HO2 +  0.26900*ACO3 +  0.50000*CO +  1.66000*HCHO +  0.06700*ORA2 +  0.25000*MO2 +  0.25000*MOH +  0.25000*ROH ';
k(:,i) = (  3.4000E-14.*exp(  2.2100E+02./T) ); 
...
% 289, <R273>
i=i+1;
Rnames{ 289} = 'MCP + MO2 = NO2 + HO2 +  1.50000*HCHO +  0.50000*HKET +  0.25000*MOH +  0.25000*ROH ';
k(:,i) = (  3.4000E-14.*exp(  2.2100E+02./T) ); 
Gstr{i,   1}='MCP';Gstr{i,   2}='MO2';
fMCP(i)=fMCP(i)-1.0;fMO2(i)=fMO2(i)-1.0;
fNO2(i)=fNO2(i)+  1.0000;fHO2(i)=fHO2(i)+  1.0000;fHCHO(i)=fHCHO(i)+  1.5000;fHKET(i)=fHKET(i)+  0.5000;fMOH(i)=fMOH(i)+  0.2500;fROH(i)=fROH(i)+  0.2500;

% 290, <R274>
i=i+1;
Rnames{ 290} = 'MVKP + MO2 = HO2 +  1.16000*ACO3 +  1.16000*XO2 +  1.50000*HCHO +  1.75000*ALD +  0.50000*MGLY +  0.25000*MOH +  0.25000*ROH +  0.29200*ORA2 ';
k(:,i) = (  8.3700E-14 ); 
...
% 291, <R275>
i=i+1;
Rnames{ 291} = 'UALP + MO2 = HO2 +  0.30500*CO +  0.77300*HCHO +  0.20300*ALD +  0.52500*KET +  0.13500*GLY +  0.10500*MGLY +  0.25000*MOH +  0.25000*ROH ';
k(:,i) = (  3.4000E-14.*exp(  2.2100E+02./T) ); 
...
% 293, <R277>
i=i+1;
Rnames{ 293} = 'BAL1 + MO2 = HO2 + BAL2 + HCHO ';
k(:,i) = (  3.5600E-14.*exp(  7.0800E+02./T) ); 
...
% 294, <R278>
i=i+1;
Rnames{ 294} = 'ADDC + MO2 = 2.00000*HO2 + HCHO +  0.32000*HKET +  0.68000*GLY +  0.68000*OP2 ';
k(:,i) = (  3.5600E-14.*exp(  7.0800E+02./T) ); 
...
% 297, <R281>
i=i+1;
Rnames{ 297} = 'OLNN + MO2 = 2.00000*HO2 + HCHO + ONIT ';
...
% 298, <R282>
i=i+1;
Rnames{ 298} = 'OLND + MO2 = 0.50000*HO2 +  0.50000*NO2 +  0.96500*HCHO +  0.93000*ALD +  0.34800*KET +  0.25000*MOH +  0.25000*ROH +  0.50000*ONIT ';
...
% 299, <R283>
i=i+1;
Rnames{ 299} = 'ADCN + MO2 = HO2 +  0.70000*NO2 + HCHO +  0.70000*GLY +  0.70000*OP2 +  0.30000*ONIT ';
k(:,i) = (  3.5600E-14 ); 
...
% 301, <R285>
i=i+1;
Rnames{ 301} = 'ETHP + ACO3 = 0.50000*HO2 +  0.50000*MO2 + ACD +  0.50000*ORA2 ';
k(:,i) = (  1.0300E-12.*exp(  2.1100E+02./T) ); 
Gstr{i,   1}='ETHP';Gstr{i,   2}='ACO3';
fETHP(i)=fETHP(i)-1.0;fACO3(i)=fACO3(i)-1.0;
fHO2(i)=fHO2(i)+  0.5000;fMO2(i)=fMO2(i)+  0.5000;fACD(i)=fACD(i)+  1.0000;fORA2(i)=fORA2(i)+  0.5000;

% 302, <R286>
i=i+1;
Rnames{ 302} = 'HC3P + ACO3 = 0.39400*HO2 +  0.58000*MO2 +  0.02600*ETHP +  0.02600*XO2 +  0.13000*HCHO +  0.27300*ALD +  0.66200*KET +  0.06700*GLY +  0.50000*ORA2 ';
k(:,i) = (  6.9000E-13.*exp(  4.6000E+02./T) ); 
Gstr{i,   1}='HC3P';Gstr{i,   2}='ACO3';
fHC3P(i)=fHC3P(i)-1.0;fACO3(i)=fACO3(i)-1.0;
fHO2(i)=fHO2(i)+  0.3940;fMO2(i)=fMO2(i)+  0.5800;fETHP(i)=fETHP(i)+  0.0260;fXO2(i)=fXO2(i)+  0.0260;fHCHO(i)=fHCHO(i)+  0.1300;fALD(i)=fALD(i)+  0.2730;fKET(i)=fKET(i)+  0.6620;fGLY(i)=fGLY(i)+  0.0670;fORA2(i)=fORA2(i)+  0.5000;

% 303, <R287>
i=i+1;
Rnames{ 303} = 'HC5P + ACO3 = 0.34200*HO2 +  0.51800*MO2 +  0.14000*ETHP +  0.19100*XO2 +  0.04200*HCHO +  0.38100*ALD +  0.82400*KET +  0.50000*ORA2 ';
k(:,i) = (  5.5900E-13.*exp(  5.2200E+02./T) ); 
Gstr{i,   1}='HC5P';Gstr{i,   2}='ACO3';
fHC5P(i)=fHC5P(i)-1.0;fACO3(i)=fACO3(i)-1.0;
fHO2(i)=fHO2(i)+  0.3420;fMO2(i)=fMO2(i)+  0.5180;fETHP(i)=fETHP(i)+  0.1400;fXO2(i)=fXO2(i)+  0.1910;fHCHO(i)=fHCHO(i)+  0.0420;fALD(i)=fALD(i)+  0.3810;fKET(i)=fKET(i)+  0.8240;fORA2(i)=fORA2(i)+  0.5000;

% 304, <R289>
i=i+1;
Rnames{ 304} = 'ETEP + ACO3 = 0.50000*HO2 +  0.50000*MO2 +  1.60000*HCHO +  0.20000*ALD +  0.50000*ORA2 ';
k(:,i) = (  9.4800E-13.*exp(  7.6500E+02./T) ); 
Gstr{i,   1}='ETEP';Gstr{i,   2}='ACO3';
fETEP(i)=fETEP(i)-1.0;fACO3(i)=fACO3(i)-1.0;
fHO2(i)=fHO2(i)+  0.5000;fMO2(i)=fMO2(i)+  0.5000;fHCHO(i)=fHCHO(i)+  1.6000;fALD(i)=fALD(i)+  0.2000;fORA2(i)=fORA2(i)+  0.5000;

% 305, <R290>
i=i+1;
Rnames{ 305} = 'OLTP + ACO3 = 0.50000*HO2 +  0.50000*MO2 + HCHO +  0.94000*ALD +  0.06000*KET +  0.50000*ORA2 ';
k(:,i) = (  8.1100E-13.*exp(  7.6500E+02./T) ); 
Gstr{i,   1}='OLTP';Gstr{i,   2}='ACO3';
fOLTP(i)=fOLTP(i)-1.0;fACO3(i)=fACO3(i)-1.0;
fHO2(i)=fHO2(i)+  0.5000;fMO2(i)=fMO2(i)+  0.5000;fHCHO(i)=fHCHO(i)+  1.0000;fALD(i)=fALD(i)+  0.9400;fKET(i)=fKET(i)+  0.0600;fORA2(i)=fORA2(i)+  0.5000;

% 306, <R291>
i=i+1;
Rnames{ 306} = 'OLIP + ACO3 = 0.50000*HO2 +  0.50000*MO2 +  1.71000*ALD +  0.29000*KET +  0.50000*ORA2 ';
k(:,i) = (  5.0900E-13.*exp(  7.6500E+02./T) ); 
Gstr{i,   1}='OLIP';Gstr{i,   2}='ACO3';
fOLIP(i)=fOLIP(i)-1.0;fACO3(i)=fACO3(i)-1.0;
fHO2(i)=fHO2(i)+  0.5000;fMO2(i)=fMO2(i)+  0.5000;fALD(i)=fALD(i)+  1.7100;fKET(i)=fKET(i)+  0.2900;fORA2(i)=fORA2(i)+  0.5000;

% 307, <ROCARO36>
i=i+1;
Rnames{ 307} = 'BENP + ACO3 = 0.70000*MO2 + HO2 +  0.30000*ORA2 +  0.00000*BALD + GLY +  0.50000*FURANONE +  0.25000*DCB2 +  0.25000*DCB3 ';
k(:,i) = (  7.4000E-13.*exp(  7.6500E+02./T) ); 
Gstr{i,   1}='BENP';Gstr{i,   2}='ACO3';
fBENP(i)=fBENP(i)-1.0;fACO3(i)=fACO3(i)-1.0;
fMO2(i)=fMO2(i)+  0.7000;fHO2(i)=fHO2(i)+  1.0000;fORA2(i)=fORA2(i)+  0.3000;fBALD(i)=fBALD(i)-  0.0000;fGLY(i)=fGLY(i)+  1.0000;fFURANONE(i)=fFURANONE(i)+  0.5000;fDCB2(i)=fDCB2(i)+  0.2500;fDCB3(i)=fDCB3(i)+  0.2500;

% 308, <ROCARO46>
i=i+1;
Rnames{ 308} = 'TOLP + ACO3 = 0.70000*MO2 +  0.91460*HO2 +  0.30000*ORA2 +  0.08540*BALD +  0.54880*GLY +  0.36590*MGLY +  0.36590*FURANONE +  0.54880*DCB1 ';
k(:,i) = (  7.4000E-13.*exp(  7.6500E+02./T) ); 
Gstr{i,   1}='TOLP';Gstr{i,   2}='ACO3';
fTOLP(i)=fTOLP(i)-1.0;fACO3(i)=fACO3(i)-1.0;
fMO2(i)=fMO2(i)+  0.7000;fHO2(i)=fHO2(i)+  0.9146;fORA2(i)=fORA2(i)+  0.3000;fBALD(i)=fBALD(i)+  0.0854;fGLY(i)=fGLY(i)+  0.5488;fMGLY(i)=fMGLY(i)+  0.3659;fFURANONE(i)=fFURANONE(i)+  0.3659;fDCB1(i)=fDCB1(i)+  0.5488;

% 309, <ROCARO56>
i=i+1;
Rnames{ 309} = 'XYLP + ACO3 = 0.70000*MO2 +  0.95180*HO2 +  0.30000*ORA2 +  0.04820*BALD +  0.70430*GLY +  0.24750*MGLY +  0.35220*FURANONE +  0.59960*DCB2 ';
k(:,i) = (  7.4000E-13.*exp(  7.6500E+02./T) ); 
Gstr{i,   1}='XYLP';Gstr{i,   2}='ACO3';
fXYLP(i)=fXYLP(i)-1.0;fACO3(i)=fACO3(i)-1.0;
fMO2(i)=fMO2(i)+  0.7000;fHO2(i)=fHO2(i)+  0.9518;fORA2(i)=fORA2(i)+  0.3000;fBALD(i)=fBALD(i)+  0.0482;fGLY(i)=fGLY(i)+  0.7043;fMGLY(i)=fMGLY(i)+  0.2475;fFURANONE(i)=fFURANONE(i)+  0.3522;fDCB2(i)=fDCB2(i)+  0.5996;

% 310, <ROCARO66>
i=i+1;
Rnames{ 310} = 'EBZP + ACO3 = 0.70000*MO2 +  0.91460*HO2 +  0.30000*ORA2 +  0.08540*BALD +  0.54880*GLY +  0.36590*MGLY +  0.45730*FURANONE +  0.45730*DCB2 ';
k(:,i) = (  7.4000E-13.*exp(  7.6500E+02./T) ); 
Gstr{i,   1}='EBZP';Gstr{i,   2}='ACO3';
fEBZP(i)=fEBZP(i)-1.0;fACO3(i)=fACO3(i)-1.0;
fMO2(i)=fMO2(i)+  0.7000;fHO2(i)=fHO2(i)+  0.9146;fORA2(i)=fORA2(i)+  0.3000;fBALD(i)=fBALD(i)+  0.0854;fGLY(i)=fGLY(i)+  0.5488;fMGLY(i)=fMGLY(i)+  0.3659;fFURANONE(i)=fFURANONE(i)+  0.4573;fDCB2(i)=fDCB2(i)+  0.4573;

% 311, <R300>
i=i+1;
Rnames{ 311} = 'ISOP + ACO3 = 0.50000*HO2 +  0.50000*MO2 +  1.04800*HCHO +  0.21900*MACR +  0.30500*MVK +  0.50000*ORA2 ';
k(:,i) = (  8.4000E-14.*exp(  2.2100E+02./T) ); 
Gstr{i,   1}='ISOP';Gstr{i,   2}='ACO3';
fISOP(i)=fISOP(i)-1.0;fACO3(i)=fACO3(i)-1.0;
fHO2(i)=fHO2(i)+  0.5000;fMO2(i)=fMO2(i)+  0.5000;fHCHO(i)=fHCHO(i)+  1.0480;fMACR(i)=fMACR(i)+  0.2190;fMVK(i)=fMVK(i)+  0.3050;fORA2(i)=fORA2(i)+  0.5000;

% 312, <R301>
i=i+1;
Rnames{ 312} = 'APIP1 + ACO3 = 0.25350*PINAL +  0.37100*ALD +  0.09100*OPB +  0.11650*ACT +  0.17250*LIMAL +  0.40300*HCHO + HO2 + MO2 +  0.11200*KET ';
k(:,i) = (  2.0000E-12.*exp(  5.0000E+02./T) ); 
Gstr{i,   1}='APIP1';Gstr{i,   2}='ACO3';
fAPIP1(i)=fAPIP1(i)-1.0;fACO3(i)=fACO3(i)-1.0;
fPINAL(i)=fPINAL(i)+  0.2535;fALD(i)=fALD(i)+  0.3710;fOPB(i)=fOPB(i)+  0.0910;fACT(i)=fACT(i)+  0.1165;fLIMAL(i)=fLIMAL(i)+  0.1725;fHCHO(i)=fHCHO(i)+  0.4030;fHO2(i)=fHO2(i)+  1.0000;fMO2(i)=fMO2(i)+  1.0000;fKET(i)=fKET(i)+  0.1120;

% 313, <TRP35>
i=i+1;
Rnames{ 313} = 'APIP2 + ACO3 = 0.50000*HO +  0.50000*MO2 +  0.50000*ORA2 + VHOM ';
k(:,i) = (  1.0000E-10 ); 
Gstr{i,   1}='APIP2';Gstr{i,   2}='ACO3';
fAPIP2(i)=fAPIP2(i)-1.0;fACO3(i)=fACO3(i)-1.0;
fHO(i)=fHO(i)+  0.5000;fMO2(i)=fMO2(i)+  0.5000;fORA2(i)=fORA2(i)+  0.5000;fVHOM(i)=fVHOM(i)+  1.0000;

% 314, <TRP36>
i=i+1;
Rnames{ 314} = 'APINP1 + ACO3 = 0.82500*NO2 +  0.65000*PINAL + MO2 +  0.17500*VTRPN +  0.16800*ALD +  0.00700*KET +  0.00700*HCHO +  0.17500*HO2 ';
k(:,i) = (  2.0000E-12.*exp(  5.0000E+02./T) ); 
Gstr{i,   1}='APINP1';Gstr{i,   2}='ACO3';
fAPINP1(i)=fAPINP1(i)-1.0;fACO3(i)=fACO3(i)-1.0;
fNO2(i)=fNO2(i)+  0.8250;fPINAL(i)=fPINAL(i)+  0.6500;fMO2(i)=fMO2(i)+  1.0000;fVTRPN(i)=fVTRPN(i)+  0.1750;fALD(i)=fALD(i)+  0.1680;fKET(i)=fKET(i)+  0.0070;fHCHO(i)=fHCHO(i)+  0.0070;fHO2(i)=fHO2(i)+  0.1750;

% 315, <TRP37>
i=i+1;
Rnames{ 315} = 'APINP2 + ACO3 = 0.50000*NO2 +  0.50000*MO2 +  0.50000*ORA2 + VHOM ';
k(:,i) = (  1.0000E-10 ); 
Gstr{i,   1}='APINP2';Gstr{i,   2}='ACO3';
fAPINP2(i)=fAPINP2(i)-1.0;fACO3(i)=fACO3(i)-1.0;
fNO2(i)=fNO2(i)+  0.5000;fMO2(i)=fMO2(i)+  0.5000;fORA2(i)=fORA2(i)+  0.5000;fVHOM(i)=fVHOM(i)+  1.0000;

% 316, <R302>
i=i+1;
Rnames{ 316} = 'LIMP1 + ACO3 = LIMAL +  0.56000*HCHO + HO2 + MO2 ';
k(:,i) = (  2.0000E-12.*exp(  5.0000E+02./T) ); 
Gstr{i,   1}='LIMP1';Gstr{i,   2}='ACO3';
fLIMP1(i)=fLIMP1(i)-1.0;fACO3(i)=fACO3(i)-1.0;
fLIMAL(i)=fLIMAL(i)+  1.0000;fHCHO(i)=fHCHO(i)+  0.5600;fHO2(i)=fHO2(i)+  1.0000;fMO2(i)=fMO2(i)+  1.0000;

% 317, <TRP38>
i=i+1;
Rnames{ 317} = 'LIMP2 + ACO3 = 0.50000*HO +  0.50000*MO2 +  0.50000*ORA2 + VHOM ';
k(:,i) = (  1.0000E-10 ); 
...
% 318, <TRP39>
i=i+1;
Rnames{ 318} = 'LIMNP1 + ACO3 = MO2 +  0.46000*NO2 +  0.46000*LIMAL +  0.54000*VTRPN +  0.54000*HO2 ';
k(:,i) = (  2.0000E-12.*exp(  5.0000E+02./T) ); 
Gstr{i,   1}='LIMNP1';Gstr{i,   2}='ACO3';
fLIMNP1(i)=fLIMNP1(i)-1.0;fACO3(i)=fACO3(i)-1.0;
fMO2(i)=fMO2(i)+  1.0000;fNO2(i)=fNO2(i)+  0.4600;fLIMAL(i)=fLIMAL(i)+  0.4600;fVTRPN(i)=fVTRPN(i)+  0.5400;fHO2(i)=fHO2(i)+  0.5400;

% 319, <TRP40>
i=i+1;
Rnames{ 319} = 'LIMNP2 + ACO3 = 0.50000*MO2 +  0.50000*NO2 +  0.50000*ORA2 + VHOM ';
k(:,i) = (  1.0000E-10 ); 
Gstr{i,   1}='LIMNP2';Gstr{i,   2}='ACO3';
fLIMNP2(i)=fLIMNP2(i)-1.0;fACO3(i)=fACO3(i)-1.0;
fMO2(i)=fMO2(i)+  0.5000;fNO2(i)=fNO2(i)+  0.5000;fORA2(i)=fORA2(i)+  0.5000;fVHOM(i)=fVHOM(i)+  1.0000;

% 320, <R303>
i=i+1;
Rnames{ 320} = 'ACO3 + ACO3 = 2.00000*MO2 ';
k(:,i) = (  2.5000E-12.*exp(  5.0000E+02./T) ); 
Gstr{i,   1}='ACO3';Gstr{i,   2}='ACO3';
fACO3(i)=fACO3(i)-1.0;fACO3(i)=fACO3(i)-1.0;
fMO2(i)=fMO2(i)+  2.0000;

% 321, <R304>
i=i+1;
Rnames{ 321} = 'RCO3 + ACO3 = MO2 + ETHP ';
k(:,i) = (  2.5000E-12.*exp(  5.0000E+02./T) ); 
Gstr{i,   1}='RCO3';Gstr{i,   2}='ACO3';
fRCO3(i)=fRCO3(i)-1.0;fACO3(i)=fACO3(i)-1.0;
fMO2(i)=fMO2(i)+  1.0000;fETHP(i)=fETHP(i)+  1.0000;

% 322, <R305>
i=i+1;
Rnames{ 322} = 'ACTP + ACO3 = 0.50000*MO2 +  0.50000*ACO3 + HCHO +  0.75000*ORA2 ';
k(:,i) = (  7.5100E-13.*exp(  5.6500E+02./T) ); 
Gstr{i,   1}='ACTP';Gstr{i,   2}='ACO3';
fACTP(i)=fACTP(i)-1.0;fACO3(i)=fACO3(i)-1.0;
fMO2(i)=fMO2(i)+  0.5000;fACO3(i)=fACO3(i)+  0.5000;fHCHO(i)=fHCHO(i)+  1.0000;fORA2(i)=fORA2(i)+  0.7500;

% 323, <R306>
i=i+1;
Rnames{ 323} = 'MEKP + ACO3 = 0.33000*HO2 +  0.50000*MO2 +  0.33000*HCHO +  0.33400*DCB1 +  0.50000*ORA2 ';
k(:,i) = (  7.5100E-13.*exp(  5.6500E+02./T) ); 
Gstr{i,   1}='MEKP';Gstr{i,   2}='ACO3';
fMEKP(i)=fMEKP(i)-1.0;fACO3(i)=fACO3(i)-1.0;
fHO2(i)=fHO2(i)+  0.3300;fMO2(i)=fMO2(i)+  0.5000;fHCHO(i)=fHCHO(i)+  0.3300;fDCB1(i)=fDCB1(i)+  0.3340;fORA2(i)=fORA2(i)+  0.5000;

% 324, <R307>
i=i+1;
Rnames{ 324} = 'KETP + ACO3 = 0.50000*HO2 +  0.50000*MO2 +  0.50000*DCB1 +  0.50000*ORA2 ';
k(:,i) = (  7.5100E-13.*exp(  5.6500E+02./T) ); 
Gstr{i,   1}='KETP';Gstr{i,   2}='ACO3';
fKETP(i)=fKETP(i)-1.0;fACO3(i)=fACO3(i)-1.0;
fHO2(i)=fHO2(i)+  0.5000;fMO2(i)=fMO2(i)+  0.5000;fDCB1(i)=fDCB1(i)+  0.5000;fORA2(i)=fORA2(i)+  0.5000;

% 325, <R308>
i=i+1;
Rnames{ 325} = 'MACP + ACO3 = 0.63500*ORA2 +  0.50000*MO2 +  0.26900*ACO3 +  0.50000*CO + HCHO ';
k(:,i) = (  8.4000E-14.*exp(  2.2100E+02./T) ); 
Gstr{i,   1}='MACP';Gstr{i,   2}='ACO3';
fMACP(i)=fMACP(i)-1.0;fACO3(i)=fACO3(i)-1.0;
fORA2(i)=fORA2(i)+  0.6350;fMO2(i)=fMO2(i)+  0.5000;fACO3(i)=fACO3(i)+  0.2690;fCO(i)=fCO(i)+  0.5000;fHCHO(i)=fHCHO(i)+  1.0000;

% 326, <R309>
i=i+1;
Rnames{ 326} = 'MCP + ACO3 = NO2 +  0.50000*HO2 + HCHO +  0.50000*HKET +  0.50000*MO2 +  0.50000*ORA2 ';
k(:,i) = (  8.4000E-14.*exp(  2.2100E+02./T) ); 
Gstr{i,   1}='MCP';Gstr{i,   2}='ACO3';
fMCP(i)=fMCP(i)-1.0;fACO3(i)=fACO3(i)-1.0;
fNO2(i)=fNO2(i)+  1.0000;fHO2(i)=fHO2(i)+  0.5000;fHCHO(i)=fHCHO(i)+  1.0000;fHKET(i)=fHKET(i)+  0.5000;fMO2(i)=fMO2(i)+  0.5000;fORA2(i)=fORA2(i)+  0.5000;

% 327, <R310>
i=i+1;
Rnames{ 327} = 'MVKP + ACO3 = 0.50000*HO2 +  0.50000*MO2 +  1.16000*ACO3 +  1.16000*XO2 + HCHO +  2.30000*ALD +  0.50000*MGLY +  1.08300*ORA2 ';
k(:,i) = (  1.6800E-12.*exp(  5.0000E+02./T) ); 
Gstr{i,   1}='MVKP';Gstr{i,   2}='ACO3';
fMVKP(i)=fMVKP(i)-1.0;fACO3(i)=fACO3(i)-1.0;
fHO2(i)=fHO2(i)+  0.5000;fMO2(i)=fMO2(i)+  0.5000;fACO3(i)=fACO3(i)+  1.1600;fXO2(i)=fXO2(i)+  1.1600;fHCHO(i)=fHCHO(i)+  1.0000;fALD(i)=fALD(i)+  2.3000;fMGLY(i)=fMGLY(i)+  0.5000;fORA2(i)=fORA2(i)+  1.0830;

% 328, <R311>
i=i+1;
Rnames{ 328} = 'UALP + ACO3 = 0.50000*HO2 +  0.50000*MO2 +  0.50000*CO +  0.03000*HCHO +  0.27000*ALD +  0.70000*KET +  0.18000*GLY +  0.10500*MGLY +  0.50000*ORA2 ';
k(:,i) = (  1.6800E-12.*exp(  5.0000E+02./T) ); 
Gstr{i,   1}='UALP';Gstr{i,   2}='ACO3';
fUALP(i)=fUALP(i)-1.0;fACO3(i)=fACO3(i)-1.0;
fHO2(i)=fHO2(i)+  0.5000;fMO2(i)=fMO2(i)+  0.5000;fCO(i)=fCO(i)+  0.5000;fHCHO(i)=fHCHO(i)+  0.0300;fALD(i)=fALD(i)+  0.2700;fKET(i)=fKET(i)+  0.7000;fGLY(i)=fGLY(i)+  0.1800;fMGLY(i)=fMGLY(i)+  0.1050;fORA2(i)=fORA2(i)+  0.5000;

% 329, <R312>
i=i+1;
Rnames{ 329} = 'BALP + ACO3 = MO2 + BAL1 ';
k(:,i) = (  7.4000E-13.*exp(  7.6500E+02./T) ); 
Gstr{i,   1}='BALP';Gstr{i,   2}='ACO3';
fBALP(i)=fBALP(i)-1.0;fACO3(i)=fACO3(i)-1.0;
fMO2(i)=fMO2(i)+  1.0000;fBAL1(i)=fBAL1(i)+  1.0000;

% 330, <R313>
i=i+1;
Rnames{ 330} = 'BAL1 + ACO3 = MO2 + BAL2 ';
k(:,i) = (  7.4000E-13.*exp(  7.6500E+02./T) ); 
Gstr{i,   1}='BAL1';Gstr{i,   2}='ACO3';
fBAL1(i)=fBAL1(i)-1.0;fACO3(i)=fACO3(i)-1.0;
fMO2(i)=fMO2(i)+  1.0000;fBAL2(i)=fBAL2(i)+  1.0000;

% 331, <R314>
i=i+1;
Rnames{ 331} = 'ADDC + ACO3 = 2.00000*HO2 + MO2 +  0.32000*HKET +  0.68000*GLY +  0.68000*OP2 ';
k(:,i) = (  7.4000E-13.*exp(  7.0800E+02./T) ); 
Gstr{i,   1}='ADDC';Gstr{i,   2}='ACO3';
fADDC(i)=fADDC(i)-1.0;fACO3(i)=fACO3(i)-1.0;
fHO2(i)=fHO2(i)+  2.0000;fMO2(i)=fMO2(i)+  1.0000;fHKET(i)=fHKET(i)+  0.3200;fGLY(i)=fGLY(i)+  0.6800;fOP2(i)=fOP2(i)+  0.6800;

% 332, <R315>
i=i+1;
Rnames{ 332} = 'MCTP + ACO3 = HO2 + MO2 + MCTO ';
k(:,i) = (  7.4000E-13.*exp(  7.0800E+02./T) ); 
Gstr{i,   1}='MCTP';Gstr{i,   2}='ACO3';
fMCTP(i)=fMCTP(i)-1.0;fACO3(i)=fACO3(i)-1.0;
fHO2(i)=fHO2(i)+  1.0000;fMO2(i)=fMO2(i)+  1.0000;fMCTO(i)=fMCTO(i)+  1.0000;

% 333, <R316>
i=i+1;
Rnames{ 333} = 'ORAP + ACO3 = MO2 + GLY ';
k(:,i) = (  7.5100E-13.*exp(  5.6500E+02./T) ); 
Gstr{i,   1}='ORAP';Gstr{i,   2}='ACO3';
fORAP(i)=fORAP(i)-1.0;fACO3(i)=fACO3(i)-1.0;
fMO2(i)=fMO2(i)+  1.0000;fGLY(i)=fGLY(i)+  1.0000;
...
% 335, <R318>
i=i+1;
Rnames{ 335} = 'OLND + ACO3 = 0.50000*MO2 + NO2 +  0.28700*HCHO +  1.24000*ALD +  0.46400*KET +  0.50000*ORA2 ';
k(:,i) = (  5.3700E-13.*exp(  7.6500E+02./T) ); 
Gstr{i,   1}='OLND';Gstr{i,   2}='ACO3';
fOLND(i)=fOLND(i)-1.0;fACO3(i)=fACO3(i)-1.0;
fMO2(i)=fMO2(i)+  0.5000;fNO2(i)=fNO2(i)+  1.0000;fHCHO(i)=fHCHO(i)+  0.2870;fALD(i)=fALD(i)+  1.2400;fKET(i)=fKET(i)+  0.4640;fORA2(i)=fORA2(i)+  0.5000;

% 336, <R319>
i=i+1;
Rnames{ 336} = 'ADCN + ACO3 = HO2 + MO2 +  0.70000*NO2 +  0.70000*GLY +  0.70000*OP2 +  0.30000*ONIT ';
k(:,i) = (  7.4000E-13.*exp(  7.0800E+02./T) ); 
Gstr{i,   1}='ADCN';Gstr{i,   2}='ACO3';
fADCN(i)=fADCN(i)-1.0;fACO3(i)=fACO3(i)-1.0;
fHO2(i)=fHO2(i)+  1.0000;fMO2(i)=fMO2(i)+  1.0000;fNO2(i)=fNO2(i)+  0.7000;fGLY(i)=fGLY(i)+  0.7000;fOP2(i)=fOP2(i)+  0.7000;fONIT(i)=fONIT(i)+  0.3000;

% 337, <R320>
i=i+1;
Rnames{ 337} = 'XO2 + ACO3 = MO2 ';
...
% 341, <R324>
i=i+1;
Rnames{ 341} = 'HC3P + NO3 = 0.25400*HO2 +  0.14000*MO2 +  0.09200*XO2 +  0.50300*ETHP + NO2 +  0.51900*ACD +  0.14700*ALD +  0.07500*MEK +  0.09500*ACT ';
k(:,i) = (  1.2000E-12 ); 
...
% 342, <R325>
i=i+1;
Rnames{ 342} = 'HC5P + NO3 = 0.48800*HO2 +  0.05500*MO2 +  0.28000*ETHP +  0.48500*XO2 + NO2 +  0.02400*HCHO +  0.24100*ALD +  0.06000*KET +  0.06300*MEK +  0.24700*ACT +  0.04800*ACD +  0.27500*HKET ';
k(:,i) = (  1.2000E-12 ); 
...
% 343, <R327>
i=i+1;
Rnames{ 343} = 'ETEP + NO3 = HO2 + NO2 +  1.60000*HCHO +  0.20000*ALD ';
k(:,i) = (  1.2000E-12 ); 
...
% 344, <R328>
i=i+1;
Rnames{ 344} = 'OLTP + NO3 = 0.47000*ALD +  0.79000*HCHO +  0.79000*HO2 + NO2 +  0.18000*MEK +  0.02000*ACD +  0.09000*ACT ';
k(:,i) = (  1.2000E-12 ); 
...
% 345, <R329>
i=i+1;
Rnames{ 345} = 'OLIP + NO3 = 0.86000*HO2 +  0.72000*ALD +  0.11000*KET + NO2 +  0.20000*ACT +  0.85000*ACD +  0.04000*HKET ';
k(:,i) = (  1.2000E-12 ); 
...
% 346, <ROCARO34>
i=i+1;
Rnames{ 346} = 'BENP + NO3 = NO2 + HO2 +  0.00000*BALD + GLY +  0.50000*FURANONE +  0.25000*DCB2 +  0.25000*DCB3 ';
k(:,i) = (  2.3000E-12 ); 
...
% 347, <ROCARO44>
i=i+1;
Rnames{ 347} = 'TOLP + NO3 = NO2 +  0.91460*HO2 +  0.08540*BALD +  0.54880*GLY +  0.36590*MGLY +  0.36590*FURANONE +  0.54880*DCB1 ';
k(:,i) = (  2.3000E-12 ); 
...
% 348, <ROCARO54>
i=i+1;
Rnames{ 348} = 'XYLP + NO3 = NO2 +  0.95180*HO2 +  0.04820*BALD +  0.70430*GLY +  0.24750*MGLY +  0.35220*FURANONE +  0.59960*DCB2 ';
k(:,i) = (  2.3000E-12 ); 
...
% 349, <ROCARO64>
i=i+1;
Rnames{ 349} = 'EBZP + NO3 = NO2 +  0.91460*HO2 +  0.08540*BALD +  0.54880*GLY +  0.36590*MGLY +  0.45730*FURANONE +  0.45730*DCB2 ';
k(:,i) = (  2.3000E-12 ); 
...
% 350, <R338>
i=i+1;
Rnames{ 350} = 'ISOP + NO3 = HO2 + NO2 +  0.75000*HCHO +  0.31800*MACR +  0.50000*MVK +  0.02400*GLY +  0.03300*HKET +  0.03100*ALD ';
k(:,i) = (  1.2000E-12 ); 
...
% 351, <R339>
i=i+1;
Rnames{ 351} = 'APIP1 + NO3 = NO2 + HO2 +  0.25350*PINAL +  0.37100*ALD +  0.11650*ACT +  0.17250*LIMAL +  0.40300*HCHO +  0.09100*OPB +  0.11200*KET ';
k(:,i) = (  2.3000E-12 ); 
...
% 352, <R340>
i=i+1;
Rnames{ 352} = 'LIMP1 + NO3 = HO2 + NO2 + LIMAL +  0.56000*HCHO ';
k(:,i) = (  2.3000E-12 ); 
...
% 353, <TRP53>
i=i+1;
Rnames{ 353} = 'APINP1 + NO3 = 1.82500*NO2 +  0.65000*PINAL +  0.17500*VTRPN +  0.16800*ALD +  0.00700*KET +  0.00700*HCHO +  0.17500*HO2 ';
k(:,i) = (  2.3000E-12 ); 
...
% 354, <TRP54>
i=i+1;
Rnames{ 354} = 'LIMNP1 + NO3 = 1.46000*NO2 +  0.46000*LIMAL +  0.54000*VTRPN +  0.54000*HO2 ';
k(:,i) = (  2.3000E-12 ); 
...
% 358, <R344>
i=i+1;
Rnames{ 358} = 'MEKP + NO3 = 0.67000*HO2 + NO2 +  0.33000*HCHO +  0.67000*DCB1 ';
k(:,i) = (  1.2000E-12 ); 
...
% 360, <R346>
i=i+1;
Rnames{ 360} = 'MACP + NO3 = HCHO +  0.53800*ACO3 + CO + NO2 ';
k(:,i) = (  1.2000E-12 ); 
...
% 362, <R348>
i=i+1;
Rnames{ 362} = 'MVKP + NO3 = 0.30000*HO2 +  0.70000*ACO3 +  0.70000*XO2 + NO2 +  0.30000*HCHO +  0.70000*ALD +  0.30000*MGLY ';
k(:,i) = (  2.5000E-12 ); 
...
% 363, <R349>
i=i+1;
Rnames{ 363} = 'UALP + NO3 = HO2 + NO2 +  0.61000*CO +  0.03000*HCHO +  0.27000*ALD +  0.70000*KET +  0.18000*GLY +  0.21000*MGLY ';
k(:,i) = (  2.5000E-12 ); 
...
% 366, <R352>
i=i+1;
Rnames{ 366} = 'ADDC + NO3 = HO2 + NO2 +  0.32000*HKET +  0.68000*GLY +  0.68000*OP2 ';
k(:,i) = (  1.2000E-12 ); 
...
% 369, <R355>
i=i+1;
Rnames{ 369} = 'OLNN + NO3 = HO2 + NO2 + ONIT ';
k(:,i) = (  1.2000E-12 ); 
...
% 370, <R356>
i=i+1;
Rnames{ 370} = 'OLND + NO3 = 2.00000*NO2 +  0.28700*HCHO +  1.24000*ALD +  0.46400*KET ';
k(:,i) = (  1.2000E-12 ); 
...
% 371, <R357>
i=i+1;
Rnames{ 371} = 'ADCN + NO3 = 2.00000*NO2 + GLY + OP2 ';
k(:,i) = (  1.2000E-12 ); 
...
% 372, <R358>
i=i+1;
Rnames{ 372} = 'OLNN + OLNN = HO2 +  2.00000*ONIT ';
...
% 373, <R359>
i=i+1;
Rnames{ 373} = 'OLNN + OLND = 0.50000*HO2 +  0.50000*NO2 +  0.20200*HCHO +  0.64000*ALD +  0.14900*KET +  1.50000*ONIT ';
...
% 374, <R360>
i=i+1;
Rnames{ 374} = 'OLND + OLND = NO2 +  0.50400*HCHO +  1.21000*ALD +  0.28500*KET + ONIT ';
...
% 378, <TRP41>
i=i+1;
Rnames{ 378} = 'APIP2 + APIP1 = 0.96000*VHOM +  0.48000*ROH +  0.48000*PINAL +  0.48000*HO +  0.48000*HO2 +  0.04000*VELHOM ';
k(:,i) = (  1.0000E-10 ); 
...
% 379, <TRP42>
i=i+1;
Rnames{ 379} = 'APIP2 + LIMP1 = 0.96000*VHOM +  0.48000*ROH +  0.48000*LIMAL +  0.48000*HO +  0.48000*HO2 +  0.04000*VELHOM ';
k(:,i) = (  1.0000E-10 ); 
...
% 380, <TRP43>
i=i+1;
Rnames{ 380} = 'APIP2 + ISOP = 0.96000*VHOM +  0.48000*ROH +  0.48000*HCHO +  0.48000*MVK +  0.48000*HO +  0.48000*HO2 +  0.04000*VELHOM ';
k(:,i) = (  1.0000E-10 ); 
...
% 381, <TRP44>
i=i+1;
Rnames{ 381} = 'LIMP2 + APIP1 = 0.96000*VHOM +  0.48000*ROH +  0.48000*PINAL +  0.48000*HO +  0.48000*HO2 +  0.04000*VELHOM ';
k(:,i) = (  1.0000E-10 ); 
...
% 382, <TRP45>
i=i+1;
Rnames{ 382} = 'LIMP2 + LIMP1 = 0.96000*VHOM +  0.48000*ROH +  0.48000*LIMAL +  0.48000*HO +  0.48000*HO2 +  0.04000*VELHOM ';
k(:,i) = (  1.0000E-10 ); 
...
% 383, <TRP46>
i=i+1;
Rnames{ 383} = 'LIMP2 + ISOP = 0.96000*VHOM +  0.48000*ROH +  0.48000*HCHO +  0.48000*MVK +  0.48000*HO +  0.48000*HO2 +  0.04000*VELHOM ';
k(:,i) = (  1.0000E-10 ); 
...
% 384, <TRP47>
i=i+1;
Rnames{ 384} = 'APINP2 + APIP1 = 0.96000*VHOM +  0.48000*ROH +  0.48000*PINAL +  0.48000*NO2 +  0.48000*HO2 +  0.04000*VELHOM ';
k(:,i) = (  1.0000E-10 ); 
...
% 385, <TRP48>
i=i+1;
Rnames{ 385} = 'APINP2 + LIMP1 = 0.96000*VHOM +  0.48000*ROH +  0.48000*LIMAL +  0.48000*NO2 +  0.48000*HO2 +  0.04000*VELHOM ';
k(:,i) = (  1.0000E-10 ); 
...
% 386, <TRP49>
i=i+1;
Rnames{ 386} = 'APINP2 + ISOP = 0.96000*VHOM +  0.48000*ROH +  0.48000*HCHO +  0.48000*MVK +  0.48000*NO2 +  0.48000*HO2 +  0.04000*VELHOM ';
k(:,i) = (  1.0000E-10 ); 
...
% 387, <TRP50>
i=i+1;
Rnames{ 387} = 'LIMNP2 + APIP1 = 0.96000*VHOM +  0.48000*ROH +  0.48000*PINAL +  0.48000*NO2 +  0.48000*HO2 +  0.04000*VELHOM ';
k(:,i) = (  1.0000E-10 ); 
...
% 388, <TRP51>
i=i+1;
Rnames{ 388} = 'LIMNP2 + LIMP1 = 0.96000*VHOM +  0.48000*ROH +  0.48000*LIMAL +  0.48000*NO2 +  0.48000*HO2 +  0.04000*VELHOM ';
k(:,i) = (  1.0000E-10 ); 
...
% 389, <TRP52>
i=i+1;
Rnames{ 389} = 'LIMNP2 + ISOP = 0.96000*VHOM +  0.48000*ROH +  0.48000*HCHO +  0.48000*MVK +  0.48000*NO2 +  0.48000*HO2 +  0.04000*VELHOM ';
k(:,i) = (  1.0000E-10 ); 
...
% 391, <R001c>
i=i+1;
Rnames{ 391} = 'VROCIOXY + HO = 0.85200*ETHP +  0.14900*ASOATJ ';
k(:,i) = (  6.8900E-12 ); 
...
% 392, <R002c>
i=i+1;
Rnames{ 392} = 'SLOWROC + HO = ETHP +  0.00101*ASOATJ ';
k(:,i) = (  6.5500E-14 ); 
...
% 393, <T17>
i=i+1;
Rnames{ 393} = 'ACRO + HO = 0.57000*MACP +  0.43000*MCP ';
k(:,i) = (  8.0000E-12.*exp(  3.8000E+02./T) ); 
...
% 394, <T18>
i=i+1;
Rnames{ 394} = 'ACRO + O3 = 0.84000*CO +  0.56000*HO2 +  0.28000*HO +  0.72000*HCHO +  0.62000*GLY ';
k(:,i) = (  2.9000E-19 ); 
Gstr{i,   1}='ACRO';Gstr{i,   2}='O3';
fACRO(i)=fACRO(i)-1.0;fO3(i)=fO3(i)-1.0;
fCO(i)=fCO(i)+  0.8400;fHO2(i)=fHO2(i)+  0.5600;fHO(i)=fHO(i)+  0.2800;fHCHO(i)=fHCHO(i)+  0.7200;fGLY(i)=fGLY(i)+  0.6200;

% 395, <T19>
i=i+1;
Rnames{ 395} = 'ACRO + NO3 = 0.68000*HCHO +  0.32000*MACP +  0.68000*XO2 +  0.68000*MGLY +  0.32000*HNO3 +  0.68000*NO2 ';
k(:,i) = (  3.4000E-15 ); 
...
% 396, <T20>
i=i+1;
Rnames{ 396} = 'ACRO = CO +  0.47700*HO2 +  0.25000*ETE +  0.35400*ACO3 +  0.20400*HO +  0.15000*HCHO +  0.02700*MO2 ';
k(:,i) = (JACRO_09 ); 
Gstr{i,   1}='ACRO';
fACRO(i)=fACRO(i)-1.0;
...
% 397, <T10>
i=i+1;
Rnames{ 397} = 'BDE13 + HO = 0.66700*BDE13P +  0.33300*UALD +  0.33300*HO2 ';
...
% 398, <T10a>
i=i+1;
Rnames{ 398} = 'BDE13P + NO = 0.96800*HO2 +  0.96800*NO2 +  0.89500*ACRO +  0.89500*HCHO +  0.07200*FURAN +  0.03200*ONIT ';
k(:,i) = (  9.0500E-12 ); 
...
% 399, <T10b>
i=i+1;
Rnames{ 399} = 'BDE13P + NO3 = HO2 + NO2 +  0.92500*ACRO +  0.92500*HCHO +  0.07500*FURAN ';
k(:,i) = (  2.3000E-12 ); 
...
% 401, <T10d>
i=i+1;
Rnames{ 401} = 'BDE13P + MO2 = 0.32000*MOH +  1.14300*HCHO +  0.87000*HO2 +  0.46300*ACRO +  0.25000*OLT +  0.23100*MVK +  0.03700*FURAN +  0.01900*UALD ';
k(:,i) = (  2.3900E-12 ); 
...
% 402, <T10e>
i=i+1;
Rnames{ 402} = 'BDE13P + ACO3 = 0.70000*MO2 +  0.30000*ORA2 +  0.80000*HO2 +  0.74000*ACRO +  0.74000*HCHO +  0.18500*MVK +  0.06000*FURAN +  0.01500*UALD ';
k(:,i) = (  1.3700E-11 ); 
Gstr{i,   1}='BDE13P';Gstr{i,   2}='ACO3';
fBDE13P(i)=fBDE13P(i)-1.0;fACO3(i)=fACO3(i)-1.0;
fMO2(i)=fMO2(i)+  0.7000;fORA2(i)=fORA2(i)+  0.3000;fHO2(i)=fHO2(i)+  0.8000;fACRO(i)=fACRO(i)+  0.7400;fHCHO(i)=fHCHO(i)+  0.7400;fMVK(i)=fMVK(i)+  0.1850;fFURAN(i)=fFURAN(i)+  0.0600;fUALD(i)=fUALD(i)+  0.0150;

% 403, <T11>
i=i+1;
Rnames{ 403} = 'BDE13 + O3 = 0.62000*ACRO +  0.63000*CO +  0.42000*HO2 +  0.08000*HO +  0.83000*HCHO +  0.17000*ETE ';
...
% 404, <T12>
i=i+1;
Rnames{ 404} = 'BDE13 + NO3 = 0.90000*OLNN +  0.10000*OLND +  0.90000*ACRO ';
k(:,i) = (  1.0000E-13 ); 
...
% 406, <R004c>
i=i+1;
Rnames{ 406} = 'FURANO2 + NO = 0.08000*ONIT +  0.92000*NO2 +  0.92000*FURANONE +  0.75000*HO2 +  0.17000*MO2 ';
k(:,i) = (  2.7000E-12.*exp(  3.6000E+02./T) ); 
...
% 407, <R005c>
i=i+1;
Rnames{ 407} = 'FURANO2 + HO2 = 0.60000*OP2 +  0.40000*FURANONE +  0.40000*HO +  0.32000*HO2 +  0.08000*MO2 ';
k(:,i) = (  3.7500E-13.*exp(  9.8000E+02./T) ); 
...
% 408, <R006c>
i=i+1;
Rnames{ 408} = 'FURANONE + HO = 0.65000*KET +  0.31000*GLY +  0.66000*HO2 +  0.34000*MO2 +  0.43000*CO +  0.04000*ASOATJ ';
k(:,i) = (  4.4000E-11 ); 
...
% 409, <R007c>
i=i+1;
Rnames{ 409} = 'FURAN + O3 = 0.02000*HO + ALD ';
k(:,i) = (  3.4300E-17 ); 
...
% 410, <R008c>
i=i+1;
Rnames{ 410} = 'FURAN + NO3 = NO2 +  0.80000*DCB1 +  0.20000*DCB3 ';
k(:,i) = (  8.9900E-12 ); 
...
% 413, <R012c>
i=i+1;
Rnames{ 413} = 'SESQNRO2 + HO2 = VROCP0OXY4 ';
...
% 414, <R013c>
i=i+1;
Rnames{ 414} = 'SESQNRO2 + NO = VROCP3OXY2 +  2.00000*NO2 ';
k(:,i) = (  2.7000E-12.*exp(  3.6000E+02./T) ); 
...
% 415, <R014c>
i=i+1;
Rnames{ 415} = 'SESQNRO2 + NO3 = VROCP3OXY2 +  2.00000*NO2 ';
k(:,i) = (  2.3000E-12 ); 
...
% 416, <R015c>
i=i+1;
Rnames{ 416} = 'SESQ + O3 = 0.98200*VROCP3OXY2 +  0.01800*VROCN2OXY2 ';
k(:,i) = (  1.2000E-14 ); 
...
% 418, <R017c>
i=i+1;
Rnames{ 418} = 'SESQRO2 + HO2 = VROCP0OXY2 ';
k(:,i) = (  2.8400E-13.*exp(  1.3000E+03./T) ); 
...
% 419, <R019c>
i=i+1;
Rnames{ 419} = 'SESQRO2 + NO3 = VROCP3OXY2 ';
k(:,i) = (  2.3000E-12 ); 
...
% 420, <R020c>
i=i+1;
Rnames{ 420} = 'SESQRO2 + NO = 0.24700*VROCP1OXY3 +  0.75300*VROCP3OXY2 +  0.75300*NO2 ';
k(:,i) = (  2.7000E-12.*exp(  3.6000E+02./T) ); 
...
% 430, <HET_IEPOXOS>
i=i+1;
Rnames{ 430} = 'IEPOXP + ASO4J = AISO3OSJ ';
...
% 440, <ROCALK7c>
i=i+1;
Rnames{ 440} = 'VROCP6ALKP + NO = 0.72000*VROCP6ALKP2 +  0.28000*VROCP4OXY2 +  0.72000*NO2 ';
k(:,i) = (  2.7000E-12.*exp(  3.6000E+02./T) ); 
...
% 441, <ROCALK8c>
i=i+1;
Rnames{ 441} = 'VROCP5ALKP + NO = 0.72000*VROCP5ALKP2 +  0.28000*VROCP3OXY2 +  0.72000*NO2 ';
k(:,i) = (  2.7000E-12.*exp(  3.6000E+02./T) ); 
...
% 442, <ROCALK9c>
i=i+1;
Rnames{ 442} = 'VROCP4ALKP + NO = 0.72000*VROCP4ALKP2 +  0.28000*VROCP2OXY2 +  0.72000*NO2 ';
k(:,i) = (  2.7000E-12.*exp(  3.6000E+02./T) ); 
...
% 443, <ROCALK10c>
i=i+1;
Rnames{ 443} = 'VROCP3ALKP + NO = 0.72000*VROCP3ALKP2 +  0.28000*VROCP1OXY1 +  0.72000*NO2 ';
k(:,i) = (  2.7000E-12.*exp(  3.6000E+02./T) ); 
...
% 444, <ROCALK11c>
i=i+1;
Rnames{ 444} = 'VROCP2ALKP + NO = 0.72000*VROCP2ALKP2 +  0.28000*VROCP0OXY2 +  0.72000*NO2 ';
k(:,i) = (  2.7000E-12.*exp(  3.6000E+02./T) ); 
...
% 445, <ROCALK12c>
i=i+1;
Rnames{ 445} = 'VROCP1ALKP + NO = 0.72000*VROCP1ALKP2 +  0.28000*VROCN1OXY1 +  0.72000*NO2 ';
k(:,i) = (  2.7000E-12.*exp(  3.6000E+02./T) ); 
...
% 446, <HC1002>
i=i+1;
Rnames{ 446} = 'HC10P + NO = 0.74000*HC10P2 +  0.26000*ONIT +  0.74000*NO2 ';
k(:,i) = (  2.7000E-12.*exp(  3.6000E+02./T) ); 
...
% 454, <ROCALK19c>
i=i+1;
Rnames{ 454} = 'VROCP6ALKP + HO2 = VROCP3OXY2 ';
k(:,i) = (  2.1700E-11 ); 
...
% 455, <ROCALK20c>
i=i+1;
Rnames{ 455} = 'VROCP5ALKP + HO2 = VROCP2OXY2 ';
k(:,i) = (  2.2000E-11 ); 
...
% 456, <ROCALK21c>
i=i+1;
Rnames{ 456} = 'VROCP4ALKP + HO2 = VROCP1OXY1 ';
k(:,i) = (  2.2500E-11 ); 
...
% 457, <ROCALK22c>
i=i+1;
Rnames{ 457} = 'VROCP3ALKP + HO2 = VROCP0OXY2 ';
k(:,i) = (  2.2600E-11 ); 
...
% 458, <ROCALK23c>
i=i+1;
Rnames{ 458} = 'VROCP2ALKP + HO2 = VROCN1OXY1 ';
k(:,i) = (  2.2700E-11 ); 
...
% 459, <ROCALK24c>
i=i+1;
Rnames{ 459} = 'VROCP1ALKP + HO2 = VROCN2OXY2 ';
k(:,i) = (  2.2700E-11 ); 
...
% 461, <ROCALK25c>
i=i+1;
Rnames{ 461} = 'VROCP6ALKP2 = HO2 + VROCP3OXY2 ';
k(:,i) = (  1.8800E-01 ); 
...
% 462, <ROCALK26c>
i=i+1;
Rnames{ 462} = 'VROCP5ALKP2 = HO2 + VROCP2OXY2 ';
k(:,i) = (  1.8800E-01 ); 
...
% 463, <ROCALK27c>
i=i+1;
Rnames{ 463} = 'VROCP4ALKP2 = HO2 + VROCP1OXY1 ';
k(:,i) = (  1.8800E-01 ); 
...
% 464, <ROCALK28c>
i=i+1;
Rnames{ 464} = 'VROCP3ALKP2 = HO2 + VROCP0OXY2 ';
k(:,i) = (  1.8800E-01 ); 
...
% 465, <ROCALK29c>
i=i+1;
Rnames{ 465} = 'VROCP2ALKP2 = HO2 + VROCN1OXY1 ';
k(:,i) = (  1.8800E-01 ); 
...
% 466, <ROCALK30c>
i=i+1;
Rnames{ 466} = 'VROCP1ALKP2 = HO2 + VROCN2OXY2 ';
k(:,i) = (  1.8800E-01 ); 
...
% 467, <HC1005>
i=i+1;
Rnames{ 467} = 'HC10P2 = HO2 + VROCP4OXY2 ';
k(:,i) = (  1.8800E-01 ); 
Gstr{i,   1}='HC10P2';
...
% 468, <ROCALK31c>
i=i+1;
Rnames{ 468} = 'VROCP6ALKP2 + NO = 0.14000*VROCP2OXY2 +  0.86000*NO2 +  0.86000*VROCP3OXY2 +  0.86000*HO2 ';
k(:,i) = (  2.7000E-12.*exp(  3.6000E+02./T) ); 
...
% 469, <ROCALK32c>
i=i+1;
Rnames{ 469} = 'VROCP5ALKP2 + NO = 0.14000*VROCP1OXY3 +  0.86000*NO2 +  0.86000*VROCP2OXY2 +  0.86000*HO2 ';
k(:,i) = (  2.7000E-12.*exp(  3.6000E+02./T) ); 
...
% 470, <ROCALK33c>
i=i+1;
Rnames{ 470} = 'VROCP4ALKP2 + NO = 0.14000*VROCP0OXY2 +  0.86000*NO2 +  0.86000*VROCP1OXY1 +  0.86000*HO2 ';
k(:,i) = (  2.7000E-12.*exp(  3.6000E+02./T) ); 
...
% 471, <ROCALK34c>
i=i+1;
Rnames{ 471} = 'VROCP3ALKP2 + NO = 0.14000*VROCN1OXY1 +  0.86000*NO2 +  0.86000*VROCP0OXY2 +  0.86000*HO2 ';
k(:,i) = (  2.7000E-12.*exp(  3.6000E+02./T) ); 
...
% 472, <ROCALK35c>
i=i+1;
Rnames{ 472} = 'VROCP2ALKP2 + NO = 0.14000*VROCN2OXY2 +  0.86000*NO2 +  0.86000*VROCN1OXY1 +  0.86000*HO2 ';
k(:,i) = (  2.7000E-12.*exp(  3.6000E+02./T) ); 
...
% 473, <ROCALK36c>
i=i+1;
Rnames{ 473} = 'VROCP1ALKP2 + NO = VROCN2OXY2 +  0.86000*NO2 +  0.86000*HO2 ';
k(:,i) = (  2.7000E-12.*exp(  3.6000E+02./T) ); 
...
% 474, <HC1006>
i=i+1;
Rnames{ 474} = 'HC10P2 + NO = 0.12000*ONIT +  0.88000*NO2 +  0.88000*KET +  0.88000*HO2 ';
k(:,i) = (  2.7000E-12.*exp(  3.6000E+02./T) ); 
...
% 475, <ROCALK37c>
i=i+1;
Rnames{ 475} = 'VROCP6ALKP2 + NO3 = NO2 + VROCP3OXY2 + HO2 ';
k(:,i) = (  2.3000E-12 ); 
...
% 476, <ROCALK38c>
i=i+1;
Rnames{ 476} = 'VROCP5ALKP2 + NO3 = NO2 + VROCP2OXY2 + HO2 ';
k(:,i) = (  2.3000E-12 ); 
...
% 477, <ROCALK39c>
i=i+1;
Rnames{ 477} = 'VROCP4ALKP2 + NO3 = NO2 + VROCP1OXY1 + HO2 ';
k(:,i) = (  2.3000E-12 ); 
...
% 478, <ROCALK40c>
i=i+1;
Rnames{ 478} = 'VROCP3ALKP2 + NO3 = NO2 + VROCP0OXY2 + HO2 ';
k(:,i) = (  2.3000E-12 ); 
...
% 479, <ROCALK41c>
i=i+1;
Rnames{ 479} = 'VROCP2ALKP2 + NO3 = NO2 + VROCN1OXY1 + HO2 ';
k(:,i) = (  2.3000E-12 ); 
...
% 480, <ROCALK42c>
i=i+1;
Rnames{ 480} = 'VROCP1ALKP2 + NO3 = NO2 + VROCN2OXY2 + HO2 ';
k(:,i) = (  2.3000E-12 ); 
...
% 481, <HC1007>
i=i+1;
Rnames{ 481} = 'HC10P2 + NO3 = NO2 + KET + HO2 ';
k(:,i) = (  2.3000E-12 ); 
...
% 482, <ROCALK43c>
i=i+1;
Rnames{ 482} = 'VROCP6ALKP2 + HO2 = VROCP1OXY3 ';
k(:,i) = (  2.1700E-11 ); 
...
% 484, <ROCALK45c>
i=i+1;
Rnames{ 484} = 'VROCP4ALKP2 + HO2 = VROCN1OXY1 ';
k(:,i) = (  2.2500E-11 ); 
...
% 485, <ROCALK46c>
i=i+1;
Rnames{ 485} = 'VROCP3ALKP2 + HO2 = VROCN2OXY2 ';
k(:,i) = (  2.2600E-11 ); 
...
% 486, <ROCALK47c>
i=i+1;
Rnames{ 486} = 'VROCP2ALKP2 + HO2 = VROCN2OXY2 ';
k(:,i) = (  2.2700E-11 ); 
...
% 487, <ROCALK48c>
i=i+1;
Rnames{ 487} = 'VROCP1ALKP2 + HO2 = VROCN2OXY2 ';
k(:,i) = (  2.2700E-11 ); 
...
% 488, <HC1008>
i=i+1;
Rnames{ 488} = 'HC10P2 + HO2 = VROCP2OXY2 ';
k(:,i) = (  2.6600E-13.*exp(  1.3000E+03./T) ); 
...
% 489, <ROCARO01>
i=i+1;
Rnames{ 489} = 'VROCP6ARO + HO = 0.84000*VROCP6AROP +  0.16000*HO2 +  0.16000*VROCP4OXY2 ';
k(:,i) = (  1.8100E-11 ); 
...
% 490, <ROCARO02>
i=i+1;
Rnames{ 490} = 'VROCP6AROP + HO2 = 0.05950*VROCP4OXY2 +  0.90480*VROCP1OXY3 +  0.03570*VROCN2OXY4 ';
k(:,i) = (  2.9100E-13.*exp(  1.3000E+03./T) ); 
...
% 491, <ROCARO03>
i=i+1;
Rnames{ 491} = 'VROCP6AROP + NO = 0.00010*VROCP4OXY2 +  0.00180*VROCP2OXY2 +  0.00010*VROCN1OXY3 +  0.99800*NO2 +  0.99800*HO2 +  0.05940*BALD +  0.46930*GLY +  0.46930*MGLY +  0.46930*FURANONE +  0.46930*DCB2 ';
k(:,i) = (  2.7000E-12.*exp(  3.6000E+02./T) ); 
...
% 492, <ROCARO04>
i=i+1;
Rnames{ 492} = 'VROCP6AROP + NO3 = NO2 +  0.94050*HO2 +  0.05950*BALD +  0.47020*GLY +  0.47020*MGLY +  0.47020*FURANONE +  0.47020*DCB2 ';
k(:,i) = (  2.3000E-12 ); 
...
% 493, <ROCARO05>
i=i+1;
Rnames{ 493} = 'VROCP6AROP + MO2 = 0.68000*HCHO +  1.31050*HO2 +  0.32000*MOH +  0.05950*BALD +  0.47020*GLY +  0.47020*MGLY +  0.47020*FURANONE +  0.47020*DCB2 ';
k(:,i) = (  3.5600E-14.*exp(  7.0800E+02./T) ); 
...
% 494, <ROCARO06>
i=i+1;
Rnames{ 494} = 'VROCP6AROP + ACO3 = 0.70000*MO2 +  0.94050*HO2 +  0.30000*ORA2 +  0.05950*BALD +  0.47020*GLY +  0.47020*MGLY +  0.47020*FURANONE +  0.47020*DCB2 ';
k(:,i) = (  7.4000E-13.*exp(  7.6500E+02./T) ); 
Gstr{i,   1}='VROCP6AROP';Gstr{i,   2}='ACO3';
fVROCP6AROP(i)=fVROCP6AROP(i)-1.0;fACO3(i)=fACO3(i)-1.0;
fMO2(i)=fMO2(i)+  0.7000;fHO2(i)=fHO2(i)+  0.9405;fORA2(i)=fORA2(i)+  0.3000;fBALD(i)=fBALD(i)+  0.0595;fGLY(i)=fGLY(i)+  0.4702;fMGLY(i)=fMGLY(i)+  0.4702;fFURANONE(i)=fFURANONE(i)+  0.4702;fDCB2(i)=fDCB2(i)+  0.4702;

% 495, <ROCARO11>
i=i+1;
Rnames{ 495} = 'VROCP5ARO + HO = 0.84000*VROCP5AROP +  0.16000*HO2 +  0.16000*VROCP3OXY2 ';
k(:,i) = (  1.8100E-11 ); 
...
% 496, <ROCARO12>
i=i+1;
Rnames{ 496} = 'VROCP5AROP + HO2 = 0.05950*VROCP3OXY2 +  0.90480*VROCP0OXY2 +  0.03570*VROCN2OXY4 ';
k(:,i) = (  2.9100E-13.*exp(  1.3000E+03./T) ); 
...
% 497, <ROCARO13>
i=i+1;
Rnames{ 497} = 'VROCP5AROP + NO = 0.00010*VROCP3OXY2 +  0.00180*VROCP1OXY3 +  0.00010*VROCN2OXY4 +  0.99800*NO2 +  0.99800*HO2 +  0.05940*VROCP4OXY2 +  0.46930*GLY +  0.46930*MGLY +  0.46930*FURANONE +  0.46930*DCB2 ';
k(:,i) = (  2.7000E-12.*exp(  3.6000E+02./T) ); 
...
% 498, <ROCARO14>
i=i+1;
Rnames{ 498} = 'VROCP5AROP + NO3 = NO2 +  0.94050*HO2 +  0.05950*VROCP4OXY2 +  0.47020*GLY +  0.47020*MGLY +  0.47020*FURANONE +  0.47020*DCB2 ';
k(:,i) = (  2.3000E-12 ); 
...
% 499, <ROCARO15>
i=i+1;
Rnames{ 499} = 'VROCP5AROP + MO2 = 0.68000*HCHO +  1.31050*HO2 +  0.32000*MOH +  0.05950*VROCP4OXY2 +  0.47020*GLY +  0.47020*MGLY +  0.47020*FURANONE +  0.47020*DCB2 ';
k(:,i) = (  3.5600E-14.*exp(  7.0800E+02./T) ); 
...
% 500, <ROCARO16>
i=i+1;
Rnames{ 500} = 'VROCP5AROP + ACO3 = 0.70000*MO2 +  0.94050*HO2 +  0.30000*ORA2 +  0.05950*VROCP4OXY2 +  0.47020*GLY +  0.47020*MGLY +  0.47020*FURANONE +  0.47020*DCB2 ';
k(:,i) = (  7.4000E-13.*exp(  7.6500E+02./T) ); 
Gstr{i,   1}='VROCP5AROP';Gstr{i,   2}='ACO3';
fVROCP5AROP(i)=fVROCP5AROP(i)-1.0;fACO3(i)=fACO3(i)-1.0;
fMO2(i)=fMO2(i)+  0.7000;fHO2(i)=fHO2(i)+  0.9405;fORA2(i)=fORA2(i)+  0.3000;fVROCP4OXY2(i)=fVROCP4OXY2(i)+  0.0595;fGLY(i)=fGLY(i)+  0.4702;fMGLY(i)=fMGLY(i)+  0.4702;fFURANONE(i)=fFURANONE(i)+  0.4702;fDCB2(i)=fDCB2(i)+  0.4702;

% 501, <ROCARO21>
i=i+1;
Rnames{ 501} = 'NAPH + HO = 0.84000*NAPHP +  0.16000*HO2 +  0.16000*VROCP3OXY2 ';
k(:,i) = (  2.3100E-11 ); 
...
% 502, <ROCARO22>
i=i+1;
Rnames{ 502} = 'NAPHP + HO2 = 0.05950*VROCP3OXY2 +  0.90480*VROCP1OXY3 +  0.03570*VROCN2OXY8 ';
k(:,i) = (  2.9100E-13.*exp(  1.3000E+03./T) ); 
...
% 503, <ROCARO23>
i=i+1;
Rnames{ 503} = 'NAPHP + NO = 0.05950*VROCP4OXY2 +  0.00180*VROCP2OXY2 +  0.00010*VROCN2OXY8 +  0.99800*NO2 +  0.99800*HO2 +  0.46930*GLY +  0.46930*MGLY +  0.46930*FURANONE +  0.46930*DCB2 ';
k(:,i) = (  2.7000E-12.*exp(  3.6000E+02./T) ); 
...
% 504, <ROCARO24>
i=i+1;
Rnames{ 504} = 'NAPHP + NO3 = NO2 +  0.94050*HO2 +  0.05950*VROCP4OXY2 +  0.47020*GLY +  0.47020*MGLY +  0.47020*FURANONE +  0.47020*DCB2 ';
k(:,i) = (  2.3000E-12 ); 
...
% 505, <ROCARO25>
i=i+1;
Rnames{ 505} = 'NAPHP + MO2 = 0.68000*HCHO +  1.31050*HO2 +  0.32000*MOH +  0.05950*VROCP4OXY2 +  0.47020*GLY +  0.47020*MGLY +  0.47020*FURANONE +  0.47020*DCB2 ';
k(:,i) = (  3.5600E-14.*exp(  7.0800E+02./T) ); 
...
% 506, <ROCARO26>
i=i+1;
Rnames{ 506} = 'NAPHP + ACO3 = 0.70000*MO2 +  0.94050*HO2 +  0.30000*ORA2 +  0.05950*VROCP4OXY2 +  0.47020*GLY +  0.47020*MGLY +  0.47020*FURANONE +  0.47020*DCB2 ';
k(:,i) = (  7.4000E-13.*exp(  7.6500E+02./T) ); 
...
% 527, <ROCARO72>
i=i+1;
Rnames{ 527} = 'STYP + HO2 = VROCP3OXY2 ';
...
% 530, <ROCARO75>
i=i+1;
Rnames{ 530} = 'STYP + MO2 = 1.37000*HO2 +  1.68000*HCHO + BALD +  0.32000*MOH ';
k(:,i) = (  2.5000E-13 ); 
