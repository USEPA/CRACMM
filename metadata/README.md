...
- All files here are autogenerated by python code from CMAQ files (see the utilities folder). Each mechanism is documented in a markdown and csv file.
  * [CRACMM1](https://github.com/USEPA/CRACMM/tree/main/metadata/cracmm1) metadata in [md](cracmm1/cracmm1_aq_species_table.md) and [csv](cracmm1/cracmm1_aq_metadata.csv)
  * [CRACMM1AMORE](https://github.com/USEPA/CRACMM/tree/main/metadata/cracmm1amore) metadata in [md](cracmm1amore/cracmm1amore_aq_species_table.md) and [csv](cracmm1amore/cracmm1amore_aq_metadata.csv)
  * [CRACMM2](https://github.com/USEPA/CRACMM/tree/main/metadata/cracmm2) metadata in [md](cracmm2/cracmm2_species_table.md) and [csv](cracmm2/cracmm2_metadata.csv)
